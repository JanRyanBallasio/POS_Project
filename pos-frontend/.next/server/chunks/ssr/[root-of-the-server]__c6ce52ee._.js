        ...
        try {
            await addCategory({
                ...
                onSuccess: (created)=>{
                    ...
                    // close only the addCategory modal, keep addProduct open if it was open
                    setTimeout(()=>{
                        closeModal("addCategory");
                        setSuccess(null);
                    }, 600);
                    // refresh category list via SWR hook
                    refetch?.();
                }
            });
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c6ce52ee._.js.map