...
axios.interceptors.request.use((config)=>{
    try {
        ...
        if (!cachedToken || now - tokenLastFetched > TOKEN_CACHE_TTL) {
            cachedToken = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
...
const productApi = {
    ...
    async getByBarcode (barcode) {
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(exactUrl);
            if (res.status === 404) {
        ...
        try {
            const res2 = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(queryUrl);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb45f510._.js.map