...
"[project]/src/app/dashboard/_pages/POS/components/rightColumn/index.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function printViaRawSpooler(bytes, printerName) {
    ...
    const printerExpr = printerName && String(printerName).trim().length ? `'${String(printerName).replace(/'/g, "''")}'` : '(Get-CimInstance Win32_Printer | Where-Object {$_.Default -eq $true}).Name';
    const ps = `
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fa4e3fe7._.js.map