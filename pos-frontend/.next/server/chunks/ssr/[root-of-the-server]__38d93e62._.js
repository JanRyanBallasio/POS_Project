...
function RightColumn({ step, setStep }) {
    ...
    const handleNewTransaction = async ()=>{
        try {
            await fetch((("TURBOPACK compile-time value", "http://localhost:5000/api") || "http://localhost:5000/api") + "/sales", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__38d93e62._.js.map