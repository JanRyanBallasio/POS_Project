...
const useSaleItems = (opts)=>{
    ...
    const fetchSaleItems = async ()=>{
        try {
            ...
            // controller returns aggregated array directly
            setSaleItems(Array.isArray(res.data) ? res.data : []);
        } catch (err) {
...
//# sourceMappingURL=src_d8482592._.js.map