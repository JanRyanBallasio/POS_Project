...
;
;
function Index({ products, onProductDeleted }) {
...
function AddCategoryModal() {
    const { activeModal, closeModal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductModal"])();
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        console.log("AddCategoryModal.handleSubmit called", {
            name
        });
        if (!name.trim()) return;
        try {
            await addCategory({
                ...
                onSuccess: (created)=>{
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Category added", {
                        style: {
