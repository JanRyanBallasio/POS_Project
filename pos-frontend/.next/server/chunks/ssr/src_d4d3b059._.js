...
const CartProvider = ({ children })=>{
    ...
    const refocusScanner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((force = false)=>{
        try {
            ...
            if (!force && active) {
                ...
                const isProductSearch = active.getAttribute?.("data-product-search") === "true" || String(active.placeholder || "").toLowerCase().includes("search by product");
                const isCustomerSearch = active.getAttribute?.("data-customer-search") === "true" || String(active.placeholder || "").toLowerCase().includes("search name");
                const isPriceInput = !!active.getAttribute?.("data-cart-price-input");
                const isQtyInput = !!active.getAttribute?.("data-cart-qty-input");
                const isCashInput = active.getAttribute?.("data-pos-cash-input") === "true" || active.getAttribute && active.getAttribute("placeholder") === "0.00";
...
;
;
function CartTable({ cart, selectedRowId, selectRow, updateCartItemQuantity, updateCartItemPrice, deleteCartItem, refocusScanner, disabled = false }) {
...
;
;
function ProductSearch({ searchQuery, searchResults, showSearchResults, handleSearchChange, handleSearchSelect, refocusScanner, disabled = false, inputRef }) {
        ...
        children: [
            ...
            showSearchResults && searchResults.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: searchResults.map((product, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        className: `p-3 hover:bg-gray-50 cursor-pointer border-b last:border-b-0 ${isAutoSelecting ? "bg-green-50 border-green-200" : ""} ${highlightedIndex === idx ? "bg-blue-100" : ""}`,
