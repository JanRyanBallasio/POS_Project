...
function useCustomerTagging() {
    ...
    const fetchCustomers = async ()=>{
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "http://3.25.180.232:5000/api")}/customers`);
...
function AddCustomerModal({ open, onOpenChange, onCustomerAdded }) {
    ...
    const handleAdd = async ()=>{
        ...
        try {
            ...
            const backendBase = (("TURBOPACK compile-time value", "http://3.25.180.232:5000/api") || "").replace(/\/$/, "");
...
const useSaleItems = ()=>{
    ...
    const fetchSaleItems = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(("TURBOPACK compile-time value", "http://3.25.180.232:5000/api") + "/sales-items");
...
const useSales = ()=>{
    ...
    const fetchSales = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(("TURBOPACK compile-time value", "http://3.25.180.232:5000/api") + "/sales");
...
function ProductStats() {
    const API_URL = ("TURBOPACK compile-time value", "http://3.25.180.232:5000/api");
...
function AddStockModal({ onSave }) {
    ...
    const handleSave = async ()=>{
        ...
        try {
            setSaving(true);
            const base = ("TURBOPACK compile-time value", "http://3.25.180.232:5000/api") ?? '';
