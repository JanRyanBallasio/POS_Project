...
const CartProvider = ({ children })=>{
    ...
    const cartTotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>cart.reduce((total, item)=>total + Number(item.product.price || 0) * item.quantity, 0), [
        cart
    ]);
...
;
;
function Calculator({ amount, setAmount, cartTotal, refocusScanner, cartIsEmpty = false }) {
...
function AddCustomerModal({ open, onOpenChange, onCustomerAdded }) {
    ...
    const validateName = async (trimmed)=>{
        ...
        setValidating(true);
        try {
            const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/customers", {
                params: {
                    name: trimmed
                }
            });
...
function POSRight({ step, setStep }) {
    ...
    const { customerQuery, setCustomerQuery, filteredCustomers, selectedCustomer, selectCustomer, clearCustomer, allCustomers, setAllCustomers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$rightCol$2f$useCustomerTagging$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCustomerTagging"])(); // no external callback — hook already selects
    // Calculator
                ...
                try {
                    ...
                    if (customerResp.data?.success && Array.isArray(customerResp.data.data)) {
                        ...
                        if (selectedCustomer?.id) {
                            const updated = customerResp.data.data.find((c)=>String(c.id) === String(selectedCustomer.id));
    ...
    const handlePrintPDF = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        try {
...
function useBarcodeScan(onScan) {
    ...
    const lastProcessedBarcode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])("");
    const lastProcessedTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    // ⚡ Faster timings
    const COOLDOWN_MS = 20; // was 50
    const SCAN_DEBOUNCE_MS = 80; // was 150
    const DUPLICATE_PREVENT_MS = 400; // was 500
    const runScan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (raw)=>{
        const now = Date.now();
    ...
    const handleBarcodeChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((e)=>{
...
function useProductSearch(products, onSelect) {
    ...
    const autoSelectTimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
;
;
function ProductSearch({ searchQuery, searchResults, showSearchResults, handleSearchChange, handleSearchSelect, clearSearch, refocusScanner, disabled = false, inputRef }) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Input"], {
                        ...
                        onBlur: ()=>{
                            // when search input loses focus, attempt non-forced scanner refocus.
                            // This lets keyboard shortcuts (which focus price/qty inputs) keep the new focus.
...
function POSLeftCol({ step }) {
    const [refocused, setRefocused] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const { cart, updateCartItemQuantity, scanAndAddToCart, addProductToCart, setScannerRef, refocusScanner, updateCartItemPrice, deleteCartItem, lastAddedItemId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const handleSearchSelect = (product)=>{
        try {
            ...
            // When an edit-price shortcut was requested, do NOT steal focus back to the product search.
            // Instead, re-dispatch cart:edit-price with the newly added id so CartTable will focus the price input.
            setTimeout(()=>{
                try {
                    if (priceEditRequestedRef.current && addedId) {
                        // ensure CartTable receives the correct id to focus
                        try {
                    ...
                    // Always attempt to focus the visible product search input so cashier can continue typing.
                    if (productSearchInputRef?.current) {
                        productSearchInputRef.current.focus();
                        productSearchInputRef.current.select?.();
                    } else {
                        // fallback: try to find the visible product search by data attribute
                        const ps = document.querySelector('[data-product-search="true"]');
                        if (ps) {
                            try {
                                ps.focus();
        ...
        // Do NOT call refocusScanner(true) here — we want typing to continue in the search input.
        } catch (err) {
            clearSearch();
            // On error, still return focus to the visible search so user can retry
            setTimeout(()=>{
                try {
                    if (productSearchInputRef?.current) {
                        productSearchInputRef.current.focus();
    ...
    const { searchQuery, searchResults, showSearchResults, handleSearchChange, clearSearch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useProductsSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductSearch"])(products, handleSearchSelect);
    ...
    // Flag set when user triggers a "edit price" shortcut (cart:edit-price).
    // Used to avoid re-focusing the product search after adding a product when the user
    // intends to immediately edit the price.
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (step === 2 || step === 3) {
            ...
            if (productSearchInputRef?.current) productSearchInputRef.current.blur();
            return;
        }
        // When entering POS tab (step === 1) focus the visible product search input
        // so normal typing goes there. Use a short timeout to allow any DOM updates.
        setTimeout(()=>{
            try {
                if (productSearchInputRef?.current) {
                    productSearchInputRef.current.focus();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        //TURBOPACK unreachable
        ;
        const selectNext = undefined;
        const selectPrev = undefined;
        // When an item is deleted, the cart-context will emit nextSelectedId.
        const onItemDeleted = undefined;
    }, [
        cart,
        selectedRowId,
        selectRow,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        // Best-effort block: prevent browser printing / devtools common shortcuts while on POS tab.
        // This is client-side only and cannot fully prevent a determined user from opening devtools.
        const onKeyDown = (e)=>{
            // Normalize key
            const k = (e.key || "").toLowerCase();
            // Block print shortcut(s) and devtools combos:
            // - Ctrl+P (print), Ctrl+Shift+P (our price shortcut), F12, Ctrl+Shift+I/J/C, Ctrl+U, Meta+Alt+I (mac)
            if (e.ctrlKey && k === "p" || e.ctrlKey && e.shiftKey && k === "p" || // Ctrl+Shift+P
            e.key === "F12" || e.ctrlKey && e.shiftKey && (k === "i" || k === "j" || k === "c") || e.ctrlKey && k === "u" || e.metaKey && e.altKey && k === "i") {
                e.preventDefault();
                e.stopPropagation();
            }
        };
        const onContext = (ev)=>{
            // Optional: block right-click context menu on POS. Remove if you need right-click.
            ev.preventDefault();
        };
        if (step === 1) {
...
function ProductStats() {
    ...
    const handleBarClick = async (data)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/products/by-category?${params.toString()}`);
...
//# sourceMappingURL=src_d4d3b059._.js.map