...
function useBarcodeScan(onScan) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const handleGlobalKeyDown = (e)=>{
            const activeElement = document.activeElement;
            const isTypingInInput = activeElement && (activeElement.tagName === 'INPUT' || activeElement.tagName === 'TEXTAREA' || activeElement.contentEditable === 'true');
            // FIXED: Don't interfere with customer search
            const isCustomerSearch = activeElement && (activeElement.getAttribute('data-customer-search') === 'true' || activeElement.placeholder?.toLowerCase().includes('search name'));
...
function POSLeftCol({ step }) {
    ...
    const { barcodeInput, inputRef, handleBarcodeChange, handleKeyPress, refocusScanner: hookRefocus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useBarcodeScan$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBarcodeScan"])(handleScanAndAddToCart);
    ...
    const { searchQuery, searchResults, showSearchResults, handleSearchChange, clearSearch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useProductsSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductSearch"])(products, handleSearchSelect); // Pass the callback here
