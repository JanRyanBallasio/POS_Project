...
;
;
const API_BASE = ("TURBOPACK compile-time value", "http://3.107.238.186:5000/api") || 'http://localhost:5000/api';
...
"[project]/src/components/global/sidebar.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AppSidebar() {
    ...
    const [loadingLogout, setLoadingLogout] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    async function handleLogout() {
        setLoadingLogout(true);
        try {
            // call backend to clear refresh token cookie / server-side state
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/logout');
        } catch (err) {
...
function AddCategoryModal() {
    ...
    const validateName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((raw)=>{
    ...
    const handleNameChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((e)=>{
...
function cacheDeleteById(id) {
    try {
        ...
        for (const [k, v] of Array.from(BARCODE_CACHE.entries())){
            if (String(v?.product?.id) === String(id)) {
...
const productApi = {
    ...
    async search (query) {
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/products/search?q=${encodeURIComponent(query)}`);
            if (response.status >= 400) {
                return [];
            }
            const json = response.data;
...
const ProductFormSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    unit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1, "Unit is required").refine((val)=>[
            "pcs",
            "kg",
            "pck"
        ].includes(val), {
...
function ProductForm({ contextBarcode, setContextBarcode, onClose }) {
    ...
    const unitStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$productFormStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductFormStore"])((s)=>s.unit);
    ...
    const setUnitStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$productFormStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductFormStore"])((s)=>s.setUnit);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ea124ce._.js.map