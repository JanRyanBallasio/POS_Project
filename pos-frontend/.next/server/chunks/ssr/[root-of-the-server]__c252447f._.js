...
const productApi = {
    ...
    async getByBarcode (barcode) {
        ...
        try {
            ...
            try {
                console.log("[productApi] exact body:", txt.length > 0 ? JSON.parse(txt) : txt);
            } catch  {
                console.log("[productApi] exact body (raw):", txt);
            }
        ...
        try {
            ...
            try {
                console.log("[productApi] query body:", txt2.length > 0 ? JSON.parse(txt2) : txt2);
            } catch  {
                console.log("[productApi] query body (raw):", txt2);
            }
            if (!res2.ok) return null;
            const qjson = typeof txt2 === "string" && txt2.length ? JSON.parse(txt2) : {
                data: []
            };
