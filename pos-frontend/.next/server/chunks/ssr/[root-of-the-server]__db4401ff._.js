...
function useRequireAuth(redirectTo = '/login') {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function check() {
            ...
            try {
                const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/refresh');
...
function useRedirectIfAuth(redirectTo = '/dashboard/main') {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccessToken"])() || ("undefined" !== 'undefined' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUser"])() ? "TURBOPACK unreachable" : null);
        if (token) {
            router.replace(redirectTo);
        ...
        const hasRefreshIndicator = "undefined" !== 'undefined' && (document.cookie.includes('refreshToken') || localStorage.getItem('user') // User was previously logged in
        );
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
...
async function registerUser(payload) {
    ...
    const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/register', body);
    return handleResponseData(resp);
}
async function loginUser(payload) {
    const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/login', payload);
    return handleResponseData(resp);
} // ...existing code...
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__db4401ff._.js.map