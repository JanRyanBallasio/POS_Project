...
;
;
function useProductSearch(onSelect, allProducts = []) {
...
;
;
function ProductSearch({ searchQuery, searchResults, showSearchResults, handleSearchChange, handleSearchSelect, clearSearch, disabled = false, inputRef, isScannerInputRef, isLoading, onAddProduct }) {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                product.name,
                                                isAutoSelecting && !isScannerInputRef?.current && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full",
                                                    children: "Auto-selecting..."
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/_pages/POS/components/leftColumn/ProductSearch.tsx",
...
function POSLeftCol({ step }) {
    ...
    const { searchQuery, searchResults, showSearchResults, handleSearchChange, clearSearch, isScannerInputRef, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useProductsSearch$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProductSearch"])(handleSearchSelect, products);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const onItemDeleted = (e)=>{
            const detail = e.detail || {};
            const nextId = detail.nextSelectedId ?? null;
            if (nextId) {
                selectRow(nextId);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const onFocusCash = ()=>{
            const el = document.querySelector('[data-pos-cash-input="true"]') || document.querySelector('input[placeholder="0.00"]');
            el?.focus();
            el?.select?.();
        };
    ...
    async function handleScanAndAddToCart(barcode) {
        ...
        const normalizeBarcode = (bc)=>bc.replace(/^0+/, "") || "0";
        ...
        const foundProduct = products.find((p)=>{
            ...
            return productBarcode === cleaned || normalizeBarcode(productBarcode) === cleanedNormalized;
        });
        if (foundProduct) {
...
//# sourceMappingURL=src_828ef11d._.js.map