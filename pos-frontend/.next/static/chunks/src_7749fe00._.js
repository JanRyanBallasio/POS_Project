...
_s(CartProvider, "4kGn47vWITJHnYxB/32D9q0sXwY=");
_c = CartProvider;
const useCart = ()=>{
    _s1();
...
_s(useBarcodeScan, "BqrBQo7RwvvoT+Al683ts64ya+4=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(MainDashboard, "M88kfgrd7Unvr/hfMAIVxST1ckg=");
_c = MainDashboard;
var _c;
...
_s(Head, "dZQanEAv/EpgAQpi0RwhgDHKCe8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductModal"]
    ];
});
...
function ProductStats() {
    ...
    const statsData = [
        ...
        {
            title: "Total Value",
            content: isLoading ? "..." : "₱ ".concat(totalValue.toLocaleString(undefined, {
...
_s(ProductStats, "lKyc5lXS7jufjxUlUlpulp/9Y0I=", false, function() {
    return [
...
function ProductCatalogToolbar(param) {
    ...
    const filteredCategories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductCatalogToolbar.useMemo[filteredCategories]": ()=>{
            ...
            if (!q) return list;
            return list.filter({
                "ProductCatalogToolbar.useMemo[filteredCategories]": (cat)=>cat.name.toLowerCase().includes(q)
            }["ProductCatalogToolbar.useMemo[filteredCategories]"]);
        }
    }["ProductCatalogToolbar.useMemo[filteredCategories]"], [
        categories,
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                children: [
                                                    ...
                                                    !categoriesLoading && !categoriesError && (filteredCategories.length > 5 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    !categoriesLoading && !categoriesError && filteredCategories.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "p-2 text-gray-400",
...
_s(ProductCatalogToolbar, "LOLaL+idm1jkVSVvoG2Acon38EM=", false, function() {
    return [
...
_s(DataTable, "qcesxkxOII4kSnS93sZ7TCL1GCs=", false, function() {
    return [
...
function ProductTable(param) {
    ...
    const mappedProducts = (filteredProducts !== null && filteredProducts !== void 0 ? filteredProducts : []).map((p)=>mapProductToPayment(p, categories));
    ...
    const handleUpdateProduct = async ()=>{
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Product updated", {
                description: "".concat(editForm.name, " has been updated.")
            });
    ...
    const handleDeleteProduct = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$products$2f$useProductApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productApi"].delete(deleteProduct.id);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Product deleted", {
                description: "".concat(deleteProduct.name, " has been deleted.")
            });
                                                                ...
                                                                children: [
                                                                    ...
                                                                    !categoriesLoading && !categoriesError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                        children: [
                                                                            ...
                                                                            categories.filter((cat)=>cat.name.toLowerCase().includes(categorySearch.toLowerCase())).length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                className: "p-2 text-gray-400",
                                                                                children: "No categories found."
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/src/app/dashboard/_pages/Products/components/productCatalog/ProductTable.tsx",
...
_s(ProductTable, "umEZPiLMTZhcBT8DB2FIJWNhgWU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCategories"]
    ];
...
const useAddCategory = ()=>{
    ...
    const addCategory = async (payload, options)=>{
        setLoading(true);
        setError(null);
        var _process_env_NEXT_PUBLIC_API_URL, _ref;
        ...
        const raw = (_ref = (_process_env_NEXT_PUBLIC_API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL) !== null && _process_env_NEXT_PUBLIC_API_URL !== void 0 ? _process_env_NEXT_PUBLIC_API_URL : ("TURBOPACK compile-time value", "http://localhost:5000/api")) !== null && _ref !== void 0 ? _ref : "";
        ...
        if (!envBase) {
            ...
            if (envBase.startsWith(":")) {
                envBase = "http://localhost".concat(envBase);
            } else {
                envBase = "http://".concat(envBase);
            }
        }
        const url = envBase ? "".concat(envBase, "/api/categories") : "/api/categories";
        ...
        try {
            ...
            if (!res.ok) {
                ...
                let msg = "Request failed with status ".concat(res.status);
                try {
                    var _json_data;
                    const json = await res.json();
                    var _json_message, _ref1, _ref2;
                    msg = (_ref2 = (_ref1 = (_json_message = json === null || json === void 0 ? void 0 : json.message) !== null && _json_message !== void 0 ? _json_message : json === null || json === void 0 ? void 0 : json.error) !== null && _ref1 !== void 0 ? _ref1 : json === null || json === void 0 ? void 0 : (_json_data = json.data) === null || _json_data === void 0 ? void 0 : _json_data.message) !== null && _ref2 !== void 0 ? _ref2 : msg;
                } catch (e) {
                //
                }
                throw new Error(msg);
            ...
            var _json_data1;
            const created = (_json_data1 = json === null || json === void 0 ? void 0 : json.data) !== null && _json_data1 !== void 0 ? _json_data1 : json;
...
function AddCategoryModal() {
    _s();
    const { isOpen, closeModal, openModal } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductModal"])();
    const { refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCategories"])();
        ...
        try {
            await addCategory({
                ...
                onSuccess: (createdRaw)=>{
                    ...
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$_internal$2f$config$2d$context$2d$client$2d$BoS53ST9$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__j__as__mutate$3e$__["mutate"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$categories$2f$useCategoryApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES_KEY"]);
                    var _created_id;
...
_s(AddCategoryModal, "OwyYOLv88e5Bf3cUNlbM0nLz2XU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductModal"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCategories"],
...
function ProductsScreen() {
    ...
    const { products: initialProducts, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex-[75%]",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$_pages$2f$Products$2f$components$2f$productCatalog$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    products: products,
...
_s(ProductsScreen, "nDgpQq9BkJzKg26ah9DKfPpTplk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"]
    ];
});
...
//# sourceMappingURL=src_7749fe00._.js.map