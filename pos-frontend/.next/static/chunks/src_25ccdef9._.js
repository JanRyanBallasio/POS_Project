...
const productApi = {
    ...
    async delete (id) {
        ...
        if (!response.ok) {
            const json = await response.json().catch(()=>({}));
            const errorMsg = (json === null || json === void 0 ? void 0 : json.error) || (json === null || json === void 0 ? void 0 : json.message) || "Failed to delete product: ".concat(response.status);
            throw new Error(errorMsg);
        }
    },
    ...
    async getByBarcode (barcode) {
        ...
        try {
            const qRes = await fetch("".concat(API_BASE_URL, "/products?barcode=").concat(encodeURIComponent(String(barcode))));
            if (qRes.ok) {
                const qJson = await qRes.json().catch(()=>({
                        data: []
                    }));
                var _qJson_data;
                const arr = (_qJson_data = qJson.data) !== null && _qJson_data !== void 0 ? _qJson_data : [];
        ...
        try {
            const r = await fetch("".concat(API_BASE_URL, "/products/barcode/").concat(encodeURIComponent(String(barcode))));
            if (r.ok) {
        ...
        try {
            ...
            var _all_find;
            return (_all_find = all.find((p)=>String(p.barcode) === String(barcode))) !== null && _all_find !== void 0 ? _all_find : null;
        } catch (e) {
            return null;
        }
    },
    async getByName (name) {
        ...
        // 1) query param (safe)
        try {
            const qRes = await fetch("".concat(API_BASE_URL, "/products?name=").concat(encodeURIComponent(String(name))));
            if (qRes.ok) {
                const qJson = await qRes.json().catch(()=>({
                        data: []
                    }));
                ...
                if (arr.length > 0) {
                    ...
                    return exact !== null && exact !== void 0 ? exact : arr[0];
                }
                return null;
            }
        } catch (e) {}
        // 2) dedicated route
        try {
            const r = await fetch("".concat(API_BASE_URL, "/products/name/").concat(encodeURIComponent(String(name))));
            if (r.ok) {
                const json = await r.json().catch(()=>({
                        data: null
                    }));
        ...
        try {
            ...
            var _all_find;
            return (_all_find = all.find((p)=>(p.name || "").toLowerCase() === lower)) !== null && _all_find !== void 0 ? _all_find : null;
        } catch (e) {
            return null;
        }
    }
...
const CartProvider = (param)=>{
    ...
    const refocusScanner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[refocusScanner]": ()=>{
            ...
            }["CartProvider.useCallback[refocusScanner]"], 100);
        }
    }["CartProvider.useCallback[refocusScanner]"], [
        scannerInputRef
    ]);
                ...
                "CartProvider.useEffect.onProductAdded": (e)=>{
                    ...
                    try {
                        ...
                        if (el) {
                            ...
                            }["CartProvider.useEffect.onProductAdded"], 50);
                        }
                    } catch (e) {}
                }
            }["CartProvider.useEffect.onProductAdded"];
...
_s(useBarcodeScan, "yVlwbWqydWe89X+WvtIUJxuU2GM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const useCategories = ()=>{
    _s();
    const { data, error, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$categories$2f$useCategoryApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CATEGORIES_KEY"], {
        "useCategories.useSWR": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$categories$2f$useCategoryApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categoryApi"].getAll()
    }["useCategories.useSWR"], {
        revalidateOnFocus: true
    });
    return {
        ...
        error: error ? error.message : null,
        refetch: mutate,
        mutate: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$_internal$2f$config$2d$context$2d$client$2d$BoS53ST9$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__j__as__mutate$3e$__["mutate"] // optional global mutate if you need it elsewhere
    };
};
_s(useCategories, "pbBX9XurWnZRjcYBDDzfT5aPhoI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
    ];
});
...
_s(ProductRegisterModal, "Zsx+EDzjqrex1OD7Yv4qSkW63RY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductModal"],
...
//# sourceMappingURL=src_25ccdef9._.js.map