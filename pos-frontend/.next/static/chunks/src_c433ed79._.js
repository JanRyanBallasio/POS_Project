...
"use client";
;
const ProductModalContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
...
_s(ProductModalProvider, "rJhdXdjIRi5zKxlKmtPjJ28ucS8=");
_c = ProductModalProvider;
function useProductModal() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ProductModalContext);
    if (!ctx) throw new Error("useProductModal must be used within ProductModalProvider");
    return ctx;
}
_s1(useProductModal, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
...
function useAddProduct() {
    ...
    const addProduct = async (product)=>{
        ...
        try {
            ...
            const barcodeExists = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$products$2f$useProductApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productApi"].getByBarcode(product.barcode ?? "");
            if (barcodeExists) {
...
const useProducts = ()=>{
    _s();
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(("TURBOPACK compile-time value", "http://13.211.162.106:5000/api") + "/products", fetcher);
    return {
        products: data || [],
        loading: isLoading,
        error,
...
//# sourceMappingURL=src_c433ed79._.js.map