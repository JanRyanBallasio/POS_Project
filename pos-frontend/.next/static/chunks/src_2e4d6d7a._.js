...
const rawFromEnv = (_ref = (_process_env_NEXT_PUBLIC_API_URL = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL) !== null && _process_env_NEXT_PUBLIC_API_URL !== void 0 ? _process_env_NEXT_PUBLIC_API_URL : ("TURBOPACK compile-time value", "http://3.25.180.232:5000/api")) !== null && _ref !== void 0 ? _ref : '';
const browserFallback = ("TURBOPACK compile-time truthy", 1) ? "".concat(window.location.protocol, "//").concat(window.location.hostname).concat(window.location.port ? ':' + window.location.port : '') : "TURBOPACK unreachable";
...
const API_BASE = env.includes('/api') ? env : "".concat(env, "/api");
...
const rawBase = (_process_env_NEXT_PUBLIC_backend_api_url = ("TURBOPACK compile-time value", "http://3.25.180.232:5000/api")) !== null && _process_env_NEXT_PUBLIC_backend_api_url !== void 0 ? _process_env_NEXT_PUBLIC_backend_api_url : "";
...
const productApi = {
    async getAll () {
        try {
            const url = "".concat(API_BASE_URL, "/products");
...
//# sourceMappingURL=src_2e4d6d7a._.js.map