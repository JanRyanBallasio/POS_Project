...
_s(CartProvider, "RDfHMNM8hdMzmhOcMMwqHULTtSw=", false, function() {
    return [
        ...
        "useCartKeyboard.useEffect": ()=>{
            ...
            const handleKeyDown = {
                "useCartKeyboard.useEffect.handleKeyDown": (e)=>{
                    var _this, _this1, _this2, _document_activeElement, _target_classList, _target_classList1;
                    console.log('🔥 Key event detected:', {
                        key: e.key,
                        code: e.code,
                        keyCode: e.keyCode,
                        which: e.which,
                        target: (_this = e.target) === null || _this === void 0 ? void 0 : _this.tagName,
                        targetClass: (_this1 = e.target) === null || _this1 === void 0 ? void 0 : _this1.className,
                        targetId: (_this2 = e.target) === null || _this2 === void 0 ? void 0 : _this2.id,
                        selectedRowId,
                        cartLength: cart.length,
                        activeElement: typeof document !== 'undefined' ? (_document_activeElement = document.activeElement) === null || _document_activeElement === void 0 ? void 0 : _document_activeElement.tagName : 'unknown'
                    });
                    if (!selectedRowId) {
                        console.log('❌ No item selected, ignoring key');
                        return;
                    }
                    const target = e.target;
                    const isInput = target.tagName === 'INPUT' || target.tagName === 'TEXTAREA' || target.isContentEditable;
                    const isOurScanner = target.id === 'barcode-scanner' || ((_target_classList = target.classList) === null || _target_classList === void 0 ? void 0 : _target_classList.contains('barcode-scanner-input'));
                    const isBody = target.tagName === 'BODY' || target === (typeof document !== 'undefined' ? document.body : null);
                    const shouldHandle = isBody || isOurScanner || !isInput;
                    console.log('🎯 Target analysis:', {
                        ...
                        isBody,
                        shouldHandle,
                        classList: (_target_classList1 = target.classList) === null || _target_classList1 === void 0 ? void 0 : _target_classList1.toString(),
                        id: target.id
                    });
                    if (!shouldHandle) {
                        console.log('❌ Wrong target, ignoring key');
                        return;
                    }
                    const isPlusKey = e.key === "+" || e.key === "Add" || e.code === "NumpadAdd" || e.code === "Equal" || e.keyCode === 107 || e.keyCode === 187 || e.code === "Equal" && e.shiftKey;
                    const isMinusKey = e.key === "-" || e.key === "Subtract" || e.code === "NumpadSubtract" || e.code === "Minus" || e.keyCode === 109 || e.keyCode === 189;
                    if (isPlusKey) {
                        console.log('✅ Plus key detected, incrementing...');
                        e.preventDefault();
                        e.stopPropagation();
                        ...
                        if (item) {
                            console.log('📈 Incrementing item:', item.product.name, 'from', item.quantity, 'to', item.quantity + 1);
                    ...
                    if (isMinusKey) {
                        console.log('✅ Minus key detected, decrementing...');
                        e.preventDefault();
                        e.stopPropagation();
                        const item = cart.find({
                            "useCartKeyboard.useEffect.handleKeyDown.item": (i)=>i.id === selectedRowId
                        ...
                        if (item && item.quantity > 1) {
                            console.log('📉 Decrementing item:', item.product.name, 'from', item.quantity, 'to', item.quantity - 1);
                            updateCartItemQuantity(item.id, item.quantity - 1);
                        } else if (item) {
            ...
            return ({
                "useCartKeyboard.useEffect": ()=>document.removeEventListener("keydown", handleKeyDown, false)
            })["useCartKeyboard.useEffect"];
        }
    }["useCartKeyboard.useEffect"], [
        selectedRowId,
...
function RightColumn(param) {
    ...
    const handleNext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RightColumn.useCallback[handleNext]": ()=>{
            const amountValue = parseFloat(amount) || 0;
    ...
    const handlePrintReceipt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RightColumn.useCallback[handlePrintReceipt]": async ()=>{
            ...
            const items = cart.map({
                "RightColumn.useCallback[handlePrintReceipt].items": (item)=>{
            ...
            }["RightColumn.useCallback[handlePrintReceipt].items"]);
            const payload = {
    ...
    const handleNewTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RightColumn.useCallback[handleNewTransaction]": async ()=>{
            ...
            try {
                ...
                const salesPayload = {
                    ...
                    items: cart.map({
                        "RightColumn.useCallback[handleNewTransaction]": (item)=>({
                                product_id: item.product.id,
                                quantity: item.quantity,
                                price: item.product.price
                            })
                    }["RightColumn.useCallback[handleNewTransaction]"])
                };
    ...
    const handleCustomerAdded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RightColumn.useCallback[handleCustomerAdded]": (newCustomer)=>{
            setAllCustomers({
                "RightColumn.useCallback[handleCustomerAdded]": (prev)=>[
                        ...prev,
                        newCustomer
                    ]
            }["RightColumn.useCallback[handleCustomerAdded]"]);
...
_s(RightColumn, "4fBGlgvQ9UOl0rrgwqIPMcJFUGQ=", false, function() {
    return [
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableBody"], {
                children: cart.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                        className: "hover:bg-gray-50 cursor-pointer transition-all duration-200 ".concat(selectedRowId === item.id ? "bg-blue-100 border-2 border-blue-500 shadow-md ring-2 ring-blue-200" : "border-2 border-transparent"),
                        onClick: ()=>selectRow(item.id),
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                className: "font-medium max-w-[140px] break-words whitespace-normal ".concat(selectedRowId === item.id ? "font-bold text-blue-800" : ""),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                className: "min-w-0 max-w-[320px] break-words whitespace-normal ".concat(selectedRowId === item.id ? "font-semibold text-blue-800" : ""),
                                children: [
                                    item.product.name,
                                    selectedRowId === item.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                    ...
                                    className: "w-28 ".concat(selectedRowId === item.id ? "border-blue-500 ring-2 ring-blue-200" : ""),
                                    onClick: (e)=>e.stopPropagation(),
                                    onChange: (e)=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                    ...
                                    min: 1,
                                    value: item.quantity,
                                    className: "w-16 ".concat(selectedRowId === item.id ? "border-blue-500 ring-2 ring-blue-200 font-bold" : ""),
                                    onClick: (e)=>e.stopPropagation(),
                                    onChange: (e)=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    className: "text-sm text-red-600 hover:underline disabled:opacity-50 ".concat(selectedRowId === item.id ? "font-bold" : ""),
                                    onClick: (e)=>{
                                        e.stopPropagation();
...
function POSLeftCol(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProductRegisterModal, {}, void 0, false, {
                fileName: "[project]/src/app/dashboard/_pages/POS/components/leftColumn/index.tsx",
                lineNumber: 159,
                columnNumber: 7
            }, this),
    ...
    const handleUpdateProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductTable.useCallback[handleUpdateProduct]": async ()=>{
            ...
            try {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$products$2f$useProductApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["productApi"].update(editProduct.id, updatedData);
...
function ProductStats() {
    _s();
    const { data: saleItems = [], error: saleItemsError, isLoading: saleItemsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])('/sales-items', fetcher);
    const { data: products = [], error: productsError, isLoading: productsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])('/products', fetcher);
...
//# sourceMappingURL=src_d8139ceb._.js.map