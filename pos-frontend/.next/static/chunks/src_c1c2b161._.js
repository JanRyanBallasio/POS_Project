        ...
        "CartProvider.useCallback[scanAndAddToCart]": async (barcode, preValidatedProduct)=>{
            ...
            try {
                ...
                if (product) {
                    ...
                    try {
                        setContextBarcode === null || setContextBarcode === void 0 ? void 0 : setContextBarcode(cleanedBarcode);
                        if (openModal) openModal("addProduct");
                        else setProductModalOpen === null || setProductModalOpen === void 0 ? void 0 : setProductModalOpen(true);
                    } catch (e) {}
...
_s(CartProvider, "/xYYB1jHXg0qJsXF/7NmhHIQfcc=", false, function() {
    return [
...
function Calculator(param) {
    let { amount, setAmount, cartTotal, cartIsEmpty = false } = param;
    _s();
...
function Receipt(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            updatedTotalPoints !== null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "text-lg",
                children: [
                    "Customer points: ",
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function POSRight(param) {
    ...
    _s();
    const { cart, cartTotal, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const { customerQuery, setCustomerQuery, filteredCustomers, selectedCustomer, selectCustomer, clearCustomer, allCustomers, setAllCustomers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$rightCol$2f$useCustomerTagging$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerTagging"])();
    // Calculator
    ...
    const finalizeSale = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSRight.useCallback[finalizeSale]": async ()=>{
            if (isProcessingSale || cart.length === 0) return;
            try {
                setIsProcessingSale(true);
                const salesPayload = {
                    ...
                    total_purchase: cartTotal,
                    items: cart.map({
                        "POSRight.useCallback[finalizeSale]": (item)=>({
                                product_id: item.product.id,
                                quantity: item.quantity,
                                price: item.product.price
                            })
                    }["POSRight.useCallback[finalizeSale]"])
                };
                // Prefer the updated customer returned from POST /sales (backend is authoritative).
                const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/sales', salesPayload);
                const payload = resp === null || resp === void 0 ? void 0 : resp.data;
                ...
                if (payload) {
                    ...
                    } else if (payload.data && payload.data.newPoints !== undefined && (selectedCustomer === null || selectedCustomer === void 0 ? void 0 : selectedCustomer.id)) {
                ...
                if (updatedCustomer && updatedCustomer.id) {
                    ...
                    setAllCustomers({
                        "POSRight.useCallback[finalizeSale]": function() {
                            let prev = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : [];
                            const idx = prev.findIndex({
                                "POSRight.useCallback[finalizeSale].idx": (p)=>String(p.id) === String(updatedCustomer.id)
                            }["POSRight.useCallback[finalizeSale].idx"]);
                            if (idx >= 0) {
                                const copy = [
                                    ...prev
                                ];
                    ...
                    try {
                        ...
                        if (((_customerResp_data = customerResp.data) === null || _customerResp_data === void 0 ? void 0 : _customerResp_data.success) && Array.isArray(customerResp.data.data)) {
                            ...
                            if (selectedCustomer === null || selectedCustomer === void 0 ? void 0 : selectedCustomer.id) {
                                const updated = customerResp.data.data.find({
                                    "POSRight.useCallback[finalizeSale].updated": (c)=>String(c.id) === String(selectedCustomer.id)
                                }["POSRight.useCallback[finalizeSale].updated"]);
    ...
    const completeTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
...
_s(POSRight, "6JyMK0jjoz2q7k0md3hvP8umyUM=", false, function() {
    return [
...
function useProductSearch(onSelect) {
    let allProducts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [];
    _s();
                    ...
                    if (exactBarcodeMatch) {
                        ...
                        if (exactNameMatch) {
                            ...
                            if (partialMatches.length > 0) {
                                ...
                                results = fuseResults.slice(0, 10).map({
...
_s(useProductSearch, "j71aGf2IUCnGvIOhT555sujTytc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ProductSearch(param) {
    let { searchQuery, searchResults, showSearchResults, handleSearchChange, handleSearchSelect, clearSearch, disabled = false, inputRef, isScannerInputRef, isLoading, onAddProduct } = param;
    _s();
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                product.name,
                                                isAutoSelecting && !(isScannerInputRef === null || isScannerInputRef === void 0 ? void 0 : isScannerInputRef.current) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full",
                                                    children: "Auto-selecting..."
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/dashboard/_pages/POS/components/leftColumn/ProductSearch.tsx",
...
function POSLeftCol(param) {
    ...
    const { searchQuery, searchResults, showSearchResults, handleSearchChange, clearSearch, isScannerInputRef, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useProductsSearch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductSearch"])(handleSearchSelect, products);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            if (step === 2 || step === 3) {
                var _productSearchInputRef_current;
                (_productSearchInputRef_current = productSearchInputRef.current) === null || _productSearchInputRef_current === void 0 ? void 0 : _productSearchInputRef_current.blur();
                return;
            }
            setTimeout({
                "POSLeftCol.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            const onFocusCash = {
                "POSLeftCol.useEffect.onFocusCash": ()=>{
                    var _el_select;
                    const el = document.querySelector('[data-pos-cash-input="true"]') || document.querySelector('input[placeholder="0.00"]');
                    el === null || el === void 0 ? void 0 : el.focus();
                    el === null || el === void 0 ? void 0 : (_el_select = el.select) === null || _el_select === void 0 ? void 0 : _el_select.call(el);
                }
            }["POSLeftCol.useEffect.onFocusCash"];
            window.addEventListener("cart:focus-cash", onFocusCash);
            return ({
                "POSLeftCol.useEffect": ()=>window.removeEventListener("cart:focus-cash", onFocusCash)
            })["POSLeftCol.useEffect"];
        }
    }["POSLeftCol.useEffect"], []);
...
_s(POSLeftCol, "yPcsbDjEmx8SzL1GWxEUibc2G2Y=", false, function() {
    return [
...
_s(ProductStats, "qWa8hIFsZqfvI0+WtLxAKe05a9c=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
    ];
...
//# sourceMappingURL=src_c1c2b161._.js.map