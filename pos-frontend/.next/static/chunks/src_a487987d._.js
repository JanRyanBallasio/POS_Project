        ...
        "useCartKeyboard.useEffect": ()=>{
            ...
            const handleKeyDown = {
                "useCartKeyboard.useEffect.handleKeyDown": (e)=>{
                    ...
                    const isScanner = target.id === 'barcode-scanner' || ((_target_classList = target.classList) === null || _target_classList === void 0 ? void 0 : _target_classList.contains('barcode-scanner-input'));
                    const isBody = target.tagName === 'BODY';
                    // Handle numpad 0 for refocusing (works anywhere and has highest priority)
                    if (e.key === "0" && e.code === "Numpad0" || e.key === "F5") {
                        e.preventDefault();
                        e.stopPropagation();
                        refocusScanner();
                        // Also dispatch the global focus event
                    ...
                    if (isPlusKey || isMinusKey) {
                        ...
                        }["useCartKeyboard.useEffect.handleKeyDown"], 50);
                    }
                }
            }["useCartKeyboard.useEffect.handleKeyDown"];
...
_s2(useCartKeyboard, "C7u3oH8b9xDanIeqMvz9LBYAFHU=", false, function() {
    return [
        useCart
    ];
});
...
function useBarcodeScan(onScan) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBarcodeScan.useEffect": ()=>{
            ...
            const focusInput = {
                "useBarcodeScan.useEffect.focusInput": ()=>{
                    try {
    ...
    const refocusScanner = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBarcodeScan.useCallback[refocusScanner]": ()=>{
            try {
                if (inputRef.current && !processingRef.current) {
                    inputRef.current.focus();
...
_s(useBarcodeScan, "xjVdYugc2wnCLzEJLbyhR+t15Fg=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
_s(CartTable, "fBBeQFEoZZyE7h/H+jskpH3NUV0=");
_c = CartTable;
var _c;
...
"[project]/src/components/pos/HiddenBarcodeScanner.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function HiddenBarcodeScanner(param) {
    let { onScan, disabled = false } = param;
    _s();
    const inputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [inputValue, setInputValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [isProcessing, setIsProcessing] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const scanTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastScanTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    // Focus the input when component mounts
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HiddenBarcodeScanner.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HiddenBarcodeScanner.useEffect": ()=>{
            const handleFocusScanner = {
                "HiddenBarcodeScanner.useEffect.handleFocusScanner": ()=>{
                    if (!disabled && inputRef.current) {
                        inputRef.current.focus();
                        setInputValue('');
                    }
            ...
            const handleGlobalKeyDown = {
                "HiddenBarcodeScanner.useEffect.handleGlobalKeyDown": (e)=>{
                    if (e.key === "0" && e.code === "Numpad0" || e.key === "F5") {
                        e.preventDefault();
                        e.stopPropagation();
                        handleFocusScanner();
            ...
            }["HiddenBarcodeScanner.useEffect.handleGlobalKeyDown"];
    ...
    const processScan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HiddenBarcodeScanner.useCallback[processScan]": (barcode)=>{
            const now = Date.now();
            ...
            try {
                ...
                setTimeout({
                    "HiddenBarcodeScanner.useCallback[processScan]": ()=>{
                        setInputValue('');
                ...
                }["HiddenBarcodeScanner.useCallback[processScan]"], 100);
            }
        }
    }["HiddenBarcodeScanner.useCallback[processScan]"], [
        onScan,
...
_s(HiddenBarcodeScanner, "QED1Gry4p8uOloyuOHGPuVxjy0g=");
_c = HiddenBarcodeScanner;
var _c;
__turbopack_context__.k.register(_c, "HiddenBarcodeScanner");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pos$2f$HiddenBarcodeScanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/pos/HiddenBarcodeScanner.tsx [app-client] (ecmascript)");
;
;
function BarcodeScannerInput(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$pos$2f$HiddenBarcodeScanner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                onScan: handleScan,
                disabled: disabled
            }, void 0, false, {
                fileName: "[project]/src/app/dashboard/_pages/POS/components/leftColumn/BarcodeScannerInput.tsx",
...
function POSLeftCol(param) {
    ...
    const { cart, updateCartItemQuantity, scanAndAddToCart, addProductToCart, setScannerRef, refocusScanner, updateCartItemPrice, deleteCartItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    const { barcodeInput, inputRef, handleBarcodeChange, handleKeyPress, refocusScanner: hookRefocus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useBarcodeScan$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBarcodeScan"])(handleScanAndAddToCart);
    ...
    async function handleScanAndAddToCart(barcode) {
        ...
        const foundProduct = products.find((p)=>{
            ...
            if (productBarcode === cleaned) {
                console.log("✅ Frontend: EXACT MATCH found: ".concat(p.name));
                return true;
            }
            if (normalizeBarcode(productBarcode) === cleanedNormalized) {
                console.log("✅ Frontend: NORMALIZED MATCH found: ".concat(p.name));
                return true;
            }
            return false;
        });
...
_s(POSLeftCol, "BOTCsvPANo46yq7qPnzj9kmIOSQ=", false, function() {
    return [
...
//# sourceMappingURL=src_a487987d._.js.map