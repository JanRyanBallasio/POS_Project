...
"[project]/src/lib/axios.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/axios.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/userStore.ts [app-client] (ecmascript)");
            ...
            const checkAuth = {
                "useRedirectIfAuth.useEffect.checkAuth": async ()=>{
                    try {
                        ...
                        // Attempt refresh
                        const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post('/auth/refresh');
...
_s(useRedirectIfAuth, "Bk3cTo8d0UKKVYGQ9OlV8gZ0IEU=", false, function() {
    return [
                ...
                "useRequireAuth.useEffect.checkAuth": async ()=>{
                    try {
                        ...
                        try {
                            ...
                            if (isExpired) {
                                // Try refresh
                                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post('/auth/refresh');
                            }
                        } catch (e) {
                            router.replace(redirectTo);
                        }
...
_s1(useRequireAuth, "Bk3cTo8d0UKKVYGQ9OlV8gZ0IEU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
const loginUser = async (credentials)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post('/auth/login', credentials);
...
const registerUser = async (data)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post('/auth/register', {
            name: data.fullname,
...
const logoutUser = async ()=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].post('/auth/logout');
    } catch (error) {
...
//# sourceMappingURL=src_c2742d80._.js.map