...
_s(CartProvider, "j9oJbfY//X6fyoKnaF+FFVarkvA=", false, function() {
    return [
        ...
        "useCartKeyboard.useEffect": ()=>{
            ...
            const handleKeyDown = {
                "useCartKeyboard.useEffect.handleKeyDown": (e)=>{
                    var _placeholder, _placeholder1;
                    ...
                    const isCustomerSearch = target.tagName === 'INPUT' && (target.getAttribute('data-customer-search') === 'true' || ((_placeholder = target.placeholder) === null || _placeholder === void 0 ? void 0 : _placeholder.toLowerCase().includes('search name')) || ((_placeholder1 = target.placeholder) === null || _placeholder1 === void 0 ? void 0 : _placeholder1.toLowerCase().includes('customer')) || target.closest('[data-customer-search]') !== null);
                    // CRITICAL FIX: Exit early for ANY customer search interaction
                    if (isCustomerSearch || window.customerSearchActive) {
                    ...
                    if (e.ctrlKey && e.key === 'Enter') {
                        ...
                        if (currentStep === 1 && (isCustomerSearch || window.customerSearchActive)) {
                            return;
                        }
                        if (currentStep === 1) {
                            if (!isCashInput) {
                                // Focus cash input if not already focused, and STOP
                                const cashInput = document.querySelector('input[placeholder="0.00"]');
                                if (cashInput) {
                                    cashInput.focus();
                                    cashInput.select();
                                }
...
_s(Calculator, "xATJ6OLs/+Rbsw/n1+tMFSu5lMs=");
_c = Calculator;
var _c;
...
function RightColumn(param) {
    ...
    const handleCustomerAutoSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RightColumn.useCallback[handleCustomerAutoSelect]": (customer)=>{
            selectCustomer(customer);
            setCustomerQuery(customer.name);
        }
    }["RightColumn.useCallback[handleCustomerAutoSelect]"], []);
    ...
    const handleNewTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RightColumn.useCallback[handleNewTransaction]": async ()=>{
            ...
            try {
                ...
                }["RightColumn.useCallback[handleNewTransaction]"], 100);
            } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RightColumn.useEffect": ()=>{
            const handlePosNext = {
                "RightColumn.useEffect.handlePosNext": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBarcodeScan.useEffect": ()=>{
            ...
            const handleFocusScanner = {
                "useBarcodeScan.useEffect.handleFocusScanner": ()=>{
            ...
            const handleGlobalKeyDown = {
                "useBarcodeScan.useEffect.handleGlobalKeyDown": (e)=>{
                    var _placeholder;
                    const activeElement = document.activeElement;
                    ...
                    const isCustomerSearch = activeElement && (activeElement.getAttribute('data-customer-search') === 'true' || ((_placeholder = activeElement.placeholder) === null || _placeholder === void 0 ? void 0 : _placeholder.toLowerCase().includes('search name')));
            ...
            }["useBarcodeScan.useEffect.handleGlobalKeyDown"];
...
_s(useBarcodeScan, "nLqxpjmK52GI1k4WSKSyKQpXR0c=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useProductSearch.useEffect": ()=>{
            if (searchResults.length === 1 && searchQuery.trim().length >= 2 && onAutoSelect) {
                const autoSelectTimer = setTimeout({
                    "useProductSearch.useEffect.autoSelectTimer": ()=>{
                        onAutoSelect(searchResults[0]);
                        clearSearch();
                    }
                }["useProductSearch.useEffect.autoSelectTimer"], 500); // 500ms delay to prevent immediate selection while typing
                return ({
                    "useProductSearch.useEffect": ()=>clearTimeout(autoSelectTimer)
                })["useProductSearch.useEffect"];
            }
        }
    }["useProductSearch.useEffect"], [
...
_s(useProductSearch, "r4tAb7jnN4Fp9hrAbR/ZjUZ1/N4=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
        ...
        children: [
            ...
            showSearchResults && searchResults.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: searchResults.map((product)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-3 hover:bg-gray-50 cursor-pointer border-b last:border-b-0 ".concat(isAutoSelecting ? "bg-green-50 border-green-200" : ""),
...
function POSLeftCol(param) {
    ...
    const { searchQuery, searchResults, showSearchResults, handleSearchChange, clearSearch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useProductsSearch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductSearch"])(products, handleSearchSelect); // Pass the callback here
...
_s(POSLeftCol, "QjPS0+Auoqq0iiIjupou2j5550c=", false, function() {
    return [
...
function ProductStats() {
    ...
    const { data: categories = [], error: categoriesError, isLoading: categoriesLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])('/categories', fetcher);
    ...
    const productCategoryMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[productCategoryMap]": ()=>{
            const map = {};
            products.forEach({
                "ProductStats.useMemo[productCategoryMap]": (p)=>{
    ...
    const categoryNameMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[categoryNameMap]": ()=>{
            const map = {};
            categories.forEach({
                "ProductStats.useMemo[categoryNameMap]": (c)=>{
                    map[c.id] = c.name;
                }
            }["ProductStats.useMemo[categoryNameMap]"]);
            return map;
        ...
        "ProductStats.useMemo[chartData]": ()=>{
            ...
            let arr = Object.entries(grouped).map({
                "ProductStats.useMemo[chartData].arr": (param)=>{
                    let [category_id, quantity] = param;
                    return {
                        category: categoryNameMap[Number(category_id)] || "Category ".concat(category_id),
                        quantity
                    };
                }
    ...
    if (saleItemsLoading || productsLoading || categoriesLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: "Loading..."
    }, void 0, false, {
    ...
    if (saleItemsError || productsError || categoriesError) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ProductStats, "a5SXcCFTQO1oWI9a9FGkMecodw4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
