...
function Calculator(param) {
    let { amount, setAmount, cartTotal, refocusScanner, cartIsEmpty = false } = param;
    _s();
...
function POSRight(param) {
    ...
    const { customerQuery, setCustomerQuery, filteredCustomers, selectedCustomer, selectCustomer, clearCustomer, allCustomers, setAllCustomers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$rightCol$2f$useCustomerTagging$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerTagging"])(); // no external callback — hook already selects
    // Calculator
    ...
    const completeTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSRight.useCallback[completeTransaction]": ()=>{
            try {
                ...
                window.customerSearchActive = false;
                setTimeout({
                    "POSRight.useCallback[completeTransaction]": ()=>refocusScanner(true)
                }["POSRight.useCallback[completeTransaction]"], 100);
            } catch (err) {
...
_s(POSRight, "94w9bCgV5od2Q3ECz9G3ouqFIEc=", false, function() {
    return [
...
_s(CartTable, "PSmCERb2TtZXYXjemzyT8bW/850=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"]
    ];
});
...
function ProductSearch(param) {
    let { searchQuery, searchResults, showSearchResults, handleSearchChange, handleSearchSelect, clearSearch, refocusScanner, disabled = false, inputRef } = param;
    _s();
            ...
            const handleKeyDown = {
                "ProductSearch.useEffect.handleKeyDown": (e)=>{
                    if (e.key === "ArrowDown") {
                        ...
                        e.stopPropagation();
                        setHighlightedIndex({
                            "ProductSearch.useEffect.handleKeyDown": (prev)=>{
...
function POSLeftCol(param) {
        ...
        try {
            ...
            setTimeout(()=>{
                try {
                    ...
                    if (productSearchInputRef === null || productSearchInputRef === void 0 ? void 0 : productSearchInputRef.current) {
                        var _productSearchInputRef_current_select, _productSearchInputRef_current;
                        productSearchInputRef.current.focus();
                        (_productSearchInputRef_current_select = (_productSearchInputRef_current = productSearchInputRef.current).select) === null || _productSearchInputRef_current_select === void 0 ? void 0 : _productSearchInputRef_current_select.call(_productSearchInputRef_current);
                    } else {
                        ...
                        if (ps) {
                            try {
                                var _ps_select;
                                ps.focus();
                                (_ps_select = ps.select) === null || _ps_select === void 0 ? void 0 : _ps_select.call(ps);
                            } catch (e) {}
                        }
                    }
                } catch (e) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            ...
            ;
            const onEditRequest = {
                "POSLeftCol.useEffect.onEditRequest": (e)=>{
                    // mark that an edit-price was requested; clear after a short window
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            if (step === 2 || step === 3) {
                ...
                if (productSearchInputRef === null || productSearchInputRef === void 0 ? void 0 : productSearchInputRef.current) productSearchInputRef.current.blur();
                return;
            }
        ...
        "POSLeftCol.useEffect": ()=>{
            ...
            const onFocusCash = {
                "POSLeftCol.useEffect.onFocusCash": ()=>{
                    // find the cash input by data attribute and focus it
                    const el = document.querySelector('[data-pos-cash-input="true"]') || document.querySelector('input[placeholder="0.00"], input[placeholder="0.00"]');
                    if (el) {
                        try {
                            var _select, _this;
                            el.focus();
                            (_select = (_this = el).select) === null || _select === void 0 ? void 0 : _select.call(_this);
                        } catch (e) {}
                    }
                }
            }["POSLeftCol.useEffect.onFocusCash"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            ...
            const onKeyDown = {
                "POSLeftCol.useEffect.onKeyDown": (e)=>{
                    // Normalize key
            ...
            }["POSLeftCol.useEffect.onKeyDown"];
            const onContext = {
                "POSLeftCol.useEffect.onContext": (ev)=>{
                    // Optional: block right-click context menu on POS. Remove if you need right-click.
                    ev.preventDefault();
                }
            }["POSLeftCol.useEffect.onContext"];
            if (step === 1) {
...
_s(POSLeftCol, "VHO6N212N3P3ISOqphV3NyC13VI=", false, function() {
    return [
...
function ProductStats() {
    ...
    const handleBarClick = async (data)=>{
        ...
        try {
            ...
            const normalized = (((_res_data = res.data) === null || _res_data === void 0 ? void 0 : _res_data.data) || []).map((item)=>{
                var _item_product_name, _ref, _item_qty, _ref1, _item_price, _item_total, _item_last_purchase, _ref2;
                return {
                    // backend returns product_name; fall back to name if present
                    name: (_ref = (_item_product_name = item.product_name) !== null && _item_product_name !== void 0 ? _item_product_name : item.name) !== null && _ref !== void 0 ? _ref : '',
                    qty: Number((_ref1 = (_item_qty = item.qty) !== null && _item_qty !== void 0 ? _item_qty : item.quantity) !== null && _ref1 !== void 0 ? _ref1 : 0) || 0,
                    price: Number((_item_price = item.price) !== null && _item_price !== void 0 ? _item_price : 0) || 0,
                    total: Number((_item_total = item.total) !== null && _item_total !== void 0 ? _item_total : 0) || 0,
                    last_purchase: (_ref2 = (_item_last_purchase = item.last_purchase) !== null && _item_last_purchase !== void 0 ? _item_last_purchase : item.last_purchase_date) !== null && _ref2 !== void 0 ? _ref2 : null
                };
            });
...
_s(ProductStats, "u0orrW8bjFdb8uaYFZTN7qE4JNY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
    ];
});
