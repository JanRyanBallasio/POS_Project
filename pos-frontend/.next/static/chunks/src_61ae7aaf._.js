...
function useCustomerTagging() {
    ...
    const fetchCustomers = async ()=>{
        try {
            const res = await fetch("".concat(("TURBOPACK compile-time value", "http://3.25.180.232:5000/api"), "/customers"));
...
function RightColumn(param) {
    ...
    const handlePrintReceipt = async ()=>{
        const base = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"].replace(/\/+$/, ""); // ensures no trailing slash
        const items = cart.map((item)=>{
            var _item_product, _item_product1, _item_product2, _item_product3;
            var _item_product_name, _ref, _ref1;
            return {
                desc: (_ref1 = (_ref = (_item_product_name = (_item_product = item.product) === null || _item_product === void 0 ? void 0 : _item_product.name) !== null && _item_product_name !== void 0 ? _item_product_name : (_item_product1 = item.product) === null || _item_product1 === void 0 ? void 0 : _item_product1.title) !== null && _ref !== void 0 ? _ref : (_item_product2 = item.product) === null || _item_product2 === void 0 ? void 0 : _item_product2.barcode) !== null && _ref1 !== void 0 ? _ref1 : "Item",
                qty: Number(item.quantity || 0),
                amount: Number(((((_item_product3 = item.product) === null || _item_product3 === void 0 ? void 0 : _item_product3.price) || 0) * item.quantity).toFixed(2))
            };
        });
        const payload = {
        ...
        try {
            const res = await fetch("".concat(base, "/receipt"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            const filename = m ? m[1] : "receipt-".concat(Date.now(), ".pdf");
    ...
    const handleNewTransaction = async ()=>{
        try {
            const base = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE"].replace(/\/+$/, "");
            await fetch("".concat(base, "/sales"), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
_s(RightColumn, "7DVkCZE4VB/vI3biRE98R5zw1WE=", false, function() {
    return [
...
const useSaleItems = ()=>{
    ...
    const fetchSaleItems = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(("TURBOPACK compile-time value", "http://3.25.180.232:5000/api") + "/sales-items");
...
const useSales = ()=>{
    ...
    const fetchSales = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(("TURBOPACK compile-time value", "http://3.25.180.232:5000/api") + "/sales");
...
function AddStockModal(param) {
    ...
    const handleSave = async ()=>{
        ...
        try {
            ...
            const base = (_process_env_NEXT_PUBLIC_backend_api_url = ("TURBOPACK compile-time value", "http://3.25.180.232:5000/api")) !== null && _process_env_NEXT_PUBLIC_backend_api_url !== void 0 ? _process_env_NEXT_PUBLIC_backend_api_url : '';
