...
function useCustomerTagging() {
    ...
    const [filteredCustomers, setFilteredCustomers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(dummyCustomers);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCustomerTagging.useEffect": ()=>{
            setFilteredCustomers(dummyCustomers.filter({
...
_s(useCustomerTagging, "DIq4n0UA5R3OW+MvhuIFEG0rSKs=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function RightColumn({ step, setStep }) {
    ...
    const { customerQuery, setCustomerQuery, filteredCustomers, selectedCustomer, selectCustomer, clearCustomer } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$rightCol$2f$useCustomerTagging$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerTagging"])();
    // Calculator
    const handleNext = ()=>{
        const amountValue = parseFloat(amount) || 0;
...
_s(RightColumn, "PbLscnx6XaSSh7ze1G725rExKxU=", false, function() {
    return [
...
const useProducts = ()=>{
    _s();
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(("TURBOPACK compile-time value", "http://localhost:5000/api") + "/products", fetcher);
    return {
        products: data || [],
        loading: isLoading,
        error,
    ...
    const searchResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductSearch.useMemo[searchResults]": ()=>{
            ...
            return products.filter({
                "useProductSearch.useMemo[searchResults]": (product)=>product.name.toLowerCase().includes(searchQuery.toLowerCase()) || product.barcode?.includes(searchQuery)
            }["useProductSearch.useMemo[searchResults]"]);
        }
    }["useProductSearch.useMemo[searchResults]"], [
        products,
...
function POSLeftCol({ step }) {
    ...
    const { cart, updateCartItemQuantity, scanAndAddToCart, setScannerRef, refocusScanner } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
...
_s(POSLeftCol, "l8Dse4J9Zfhjd+MhRDMcYy6KcZQ=", false, function() {
    return [
...
function Head({ onProductAdded }) {
    ...
    const { open, setOpen, barcode, setBarcode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductModal"])();
    const [category_id, setCategoryId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const { addProduct, loading, error, success, reset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$products$2f$useAddProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAddProduct"])();
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DropdownMenuContent, {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        !categoriesLoading && !categoriesError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                            children: [
                                                                                categories.filter((cat)=>cat.name.toLowerCase().includes(categorySearch.toLowerCase())).map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DropdownMenuItem, {
                                                                                        onClick: ()=>{
...
_s(Head, "TKHdPkaUHdmiZd5YnDuJtYBCf4g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$productRegister$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductModal"],
...
_c = ProductsStats;
var _c;
__turbopack_context__.k.register(_c, "ProductsStats");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const useCategories = ()=>{
    ...
    const fetchCategories = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$categories$2f$useCategoryApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["categoryApi"].getAll();
            setCategories(data);
        } catch (error) {
...
_s(ProductCatalogToolbar, "DMFI92+HwL5KhcoVwa0zm9GXkm8=", false, function() {
    return [
...
const columns = [
    {
        ...
        header: ({ column })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
function ProductTable({ products, selectedCategory, selectedStatus, onProductDeleted }) {
    ...
    const [filteredCount, setFilteredCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
...
_s(ProductTable, "ulb2hgeDqFx94IdELnYBIJi1fG0=");
_c = ProductTable;
var _c;
...
function ProductsScreen() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex-[7%]",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$_pages$2f$Products$2f$components$2f$head$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
function ProductStats() {
    ...
    const { saleItems, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useSaleItems$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSaleItems"])();
    const { products } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"])();
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[chartData]": ()=>{
            ...
            let arr = Object.entries(grouped).map({
                "ProductStats.useMemo[chartData].arr": ([product_id, quantity])=>({
...
_s(ProductStats, "VxM9cu8lxyahY+AggBqaYbJnYpY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useSaleItems$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSaleItems"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"]
    ];
...
function ProductStats() {
    _s();
    const { sales, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useSales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSales"])();
    const today = new Date();
    const startOfMonth = new Date(today.getFullYear(), today.getMonth(), 1);
    const [range, setRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[chartData]": ()=>{
            ...
            return Object.entries(grouped).map({
                "ProductStats.useMemo[chartData]": ([date, customers])=>({
                        date,
...
_s(ProductStats, "fAfqyrXjZ5mH5h3zSkmRMWm3kLI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useSales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSales"]
    ];
});
...
//# sourceMappingURL=src_8bf45534._.js.map