...
function useRedirectIfAuth() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRedirectIfAuth.useEffect": ()=>{
            ...
            const hasRefreshIndicator = "object" !== 'undefined' && (document.cookie.includes('refreshToken') || localStorage.getItem('user') // User was previously logged in
            );
...
_s(LoginForm, "1lM9cOAIpOcugKXYGEi2YNO4rUM=", false, function() {
    return [
...
//# sourceMappingURL=src_2d919200._.js.map