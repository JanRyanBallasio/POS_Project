...
const getTabId = ()=>{
    ...
    if (!tabId) {
        tabId = "tab-".concat(Date.now(), "-").concat(Math.random().toString(36).substr(2, 9));
...
const useCartStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
    ...
    name: "pos-cart-storage-".concat(getTabId()),
    partialize: (state)=>({
            cart: state.cart,
...
const useCartTotal = ()=>{
    ...
    const cart = useCartStore({
        "useCartTotal.useCartStore[cart]": (state)=>state.cart
    }["useCartTotal.useCartStore[cart]"]);
    return cart.reduce((total, item)=>total + Number(item.product.price || 0) * item.quantity, 0);
};
_s(useCartTotal, "L4Q9CYCqIhEZ8aSQ0u+u5YP3sD0=", false, function() {
    return [
        useCartStore
    ];
});
...
const CartProvider = (param)=>{
    ...
    _s();
    // Use Zustand store
    const { cart, lastAddedItemId, scanError, isScanning, addProductToCart: storeAddProductToCart, updateCartItemQuantity: storeUpdateCartItemQuantity, updateCartItemPrice: storeUpdateCartItemPrice, deleteCartItem: storeDeleteCartItem, clearCart: storeClearCart, setScanError, setIsScanning, setLastAddedItemId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$cartStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])();
    const cartTotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$cartStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartTotal"])();
    const [pendingScans, setPendingScans] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(new Set());
    const lastScanTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
        ...
        "CartProvider.useCallback[deleteCartItem]": (id)=>{
            ...
            if (cart.length > 0) {
                ...
                if (cart.length > 1) {
                    var _cart_;
                    var _cart__id;
                    nextSelectedId = idx > 0 ? cart[idx - 1].id : (_cart__id = (_cart_ = cart[1]) === null || _cart_ === void 0 ? void 0 : _cart_.id) !== null && _cart__id !== void 0 ? _cart__id : null;
                }
            }
    ...
    const scanAndAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[scanAndAddToCart]": async (barcode, preValidatedProduct)=>{
            ...
            try {
                ...
                let product = preValidatedProduct !== null && preValidatedProduct !== void 0 ? preValidatedProduct : null;
                if (!product) {
                    try {
...
_s(CartProvider, "/3mJzftnis13Xg2Mznh7wHcZaBk=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$cartStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartTotal"],
...
function useCartKeyboard(selectedRowId) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useCartKeyboard.useEffect": ()=>{
            const dispatch = {
                "useCartKeyboard.useEffect.dispatch": (name, detail)=>window.dispatchEvent(new CustomEvent(name, {
                        detail
                    }))
            }["useCartKeyboard.useEffect.dispatch"];
            const handler = {
                "useCartKeyboard.useEffect.handler": (e)=>{
                    var _active_getAttribute, _active_getAttribute1;
                    const active = document.activeElement;
                    const isSearchInput = (active === null || active === void 0 ? void 0 : (_active_getAttribute = active.getAttribute) === null || _active_getAttribute === void 0 ? void 0 : _active_getAttribute.call(active, "data-product-search")) === "true";
                    const isSearchOpen = (active === null || active === void 0 ? void 0 : (_active_getAttribute1 = active.getAttribute) === null || _active_getAttribute1 === void 0 ? void 0 : _active_getAttribute1.call(active, "data-search-open")) === "true";
                    const key = e.key;
                    ...
                    if (key === "ArrowDown") {
                        ...
                        ps === null || ps === void 0 ? void 0 : ps.blur();
                        const id = selectedRowId || ((_document_querySelector = document.querySelector('[data-cart-selected="true"]')) === null || _document_querySelector === void 0 ? void 0 : _document_querySelector.getAttribute("data-cart-id")) || null;
                        ...
                        e.preventDefault();
                        e.stopPropagation();
                        const id = selectedRowId || ((_document_querySelector1 = document.querySelector('[data-cart-selected="true"]')) === null || _document_querySelector1 === void 0 ? void 0 : _document_querySelector1.getAttribute("data-cart-id")) || null;
                        if (id) {
                            // Focus the quantity input for the selected item
                            const qtyInput = document.querySelector('[data-cart-qty-input="'.concat(id, '"]'));
                            if (qtyInput) {
                                // Use requestAnimationFrame to ensure focus happens after any competing handlers
                                requestAnimationFrame({
                                    "useCartKeyboard.useEffect.handler": ()=>{
                                        qtyInput.focus();
                                        qtyInput.select();
                                    }
                                }["useCartKeyboard.useEffect.handler"]);
                        ...
                        e.preventDefault();
                        e.stopPropagation();
                        const id = selectedRowId || ((_document_querySelector2 = document.querySelector('[data-cart-selected="true"]')) === null || _document_querySelector2 === void 0 ? void 0 : _document_querySelector2.getAttribute("data-cart-id")) || null;
            ...
            return ({
                "useCartKeyboard.useEffect": ()=>window.removeEventListener("keydown", handler, {
                        capture: true
                    })
            })["useCartKeyboard.useEffect"];
        }
...
_s2(useCartKeyboard, "OD7bBpZva5O2jO+Puf00hKivP7c=");
var _c;
...
"[project]/src/app/dashboard/_pages/POS/components/rightColumn/index.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function loadLogoAsRaster(filePath) {
    let targetWidth = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 144;
    if (!fs.existsSync(filePath)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(0);
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(bytes);
}
// === Build the receipt text ===
function buildEscposReceipt(data) {
    var _data_store, _data_store1, _data_store2, _data_customer;
    ...
    // Store header
    if ((_data_store = data.store) === null || _data_store === void 0 ? void 0 : _data_store.name) {
        r += '\x1B\x21\x30' + data.store.name + '\x1B\x21\x00\n'; // Double height bold
    }
    if ((_data_store1 = data.store) === null || _data_store1 === void 0 ? void 0 : _data_store1.address1) r += data.store.address1 + '\n';
    if ((_data_store2 = data.store) === null || _data_store2 === void 0 ? void 0 : _data_store2.address2) r += data.store.address2 + '\n';
    r += '\n';
    // Info section
    r += '\x1B\x61\x00'; // left align
    r += padRight('Customer:', 12) + (((_data_customer = data.customer) === null || _data_customer === void 0 ? void 0 : _data_customer.name) || '') + '\n';
...
async function printViaRawSpooler(bytes, printerName) {
    ...
    await new Promise((resolve, reject)=>{
        ...
        child.on('close', (code)=>{
            if (code === 0) resolve();
            else reject(new Error("WritePrinter failed (exit ".concat(code, ") ").concat(stderr || stdout)));
        });
    });
    try {
        fs.unlinkSync(tmp);
...
async function printReceipt(data) {
    ...
    const logoPath = path.join(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].cwd(), 'assets/logo.png');
    let logoWidth = 144; // fixed
    const logoBuf = await loadLogoAsRaster(logoPath, logoWidth).catch(()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(0));
    const text = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(buildEscposReceipt(data), 'binary');
    const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from('\x1B\x40\x1B\x61\x01', 'binary'),
        logoBuf,
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from('\x1B\x61\x00\n', 'binary'),
        text
    ]);
...
const createDebugProduct = (debugCode)=>{
    ...
    return {
        id: "debug-".concat(quantity),
        name: "Debug Product ".concat(quantity),
        barcode: debugCode,
        price: 10.00,
        quantity: quantity,
        category_id: 1,
...
const createMultipleDebugProducts = (debugCode)=>{
    ...
    for(let i = 0; i < quantity; i++){
        products.push({
            id: "debug-".concat(i + 1),
            name: "Debug Product ".concat(i + 1),
            barcode: "".concat(debugCode, "-").concat(i + 1),
            price: 10.00,
            quantity: 1,
            category_id: 1,
            unit: 'pcs'
...
function useProductSearch(onSelect) {
    let allProducts = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], onUnregisteredBarcode = arguments.length > 2 ? arguments[2] : void 0;
    _s();
    ...
    const fuse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useProductSearch.useMemo[fuse]": ()=>{
            if (!allProducts.length) return null;
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fuse$2e$js$2f$dist$2f$fuse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](allProducts, {
                keys: [
                    {
                        name: 'name',
                        weight: 0.7
    ...
    const lastKeyTimeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const isScannerInputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const lastProcessedBarcodeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("");
    // Store the onSelect callback in a ref to prevent debounce recreation
    const onSelectRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(onSelect);
    ...
    const searchCache = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Map());
    // Add function to handle debug product selection
    const handleDebugProductSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useProductSearch.useCallback[handleDebugProductSelect]": (debugCode)=>{
            const multipleProducts = createMultipleDebugProducts(debugCode);
            // Add each product to cart individually
            multipleProducts.forEach({
                "useProductSearch.useCallback[handleDebugProductSelect]": (product)=>{
                    onSelectRef.current(product);
                }
            }["useProductSearch.useCallback[handleDebugProductSelect]"]);
    ...
    const searchProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2e$debounce$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "useProductSearch.useCallback[searchProducts]": async (q)=>{
            ...
            if (searchCache.current.has(cacheKey)) {
                ...
                if (cachedResults.length === 1 && !isDebugCheatCode(q)) {
                    ...
                    if (isScannerInputRef.current || isExactBarcodeMatch || isExactNameMatch) {
                        setTimeout({
                            "useProductSearch.useCallback[searchProducts]": ()=>{
                        ...
                        }["useProductSearch.useCallback[searchProducts]"], 100);
                    }
                }
                return;
            }
            if (q.trim().length === 1) {
                const quickResults = allProducts.filter({
                    "useProductSearch.useCallback[searchProducts].quickResults": (product)=>product.name.toLowerCase().startsWith(q.toLowerCase())
                }["useProductSearch.useCallback[searchProducts].quickResults"]).slice(0, 5);
            ...
            try {
                ...
                if (fuse && allProducts.length > 0) {
                    ...
                    const exactBarcodeMatch = allProducts.find({
                        "useProductSearch.useCallback[searchProducts].exactBarcodeMatch": (product)=>product.barcode && product.barcode.trim() === cleanedQuery.trim()
                    }["useProductSearch.useCallback[searchProducts].exactBarcodeMatch"]);
                    if (exactBarcodeMatch) {
                        ...
                        const exactNameMatch = allProducts.find({
                            "useProductSearch.useCallback[searchProducts].exactNameMatch": (product)=>product.name.toLowerCase().trim() === cleanedQuery.toLowerCase().trim()
                        }["useProductSearch.useCallback[searchProducts].exactNameMatch"]);
                        if (exactNameMatch) {
                            results = [
                                exactNameMatch
                            ];
                            ...
                            const partialMatches = allProducts.filter({
                                "useProductSearch.useCallback[searchProducts].partialMatches": (product)=>product.name.toLowerCase().includes(cleanedQuery.toLowerCase())
                            }["useProductSearch.useCallback[searchProducts].partialMatches"]);
                            if (partialMatches.length > 0) {
                                ...
                                results = fuseResults.slice(0, 50).map({
                                    "useProductSearch.useCallback[searchProducts]": (result)=>result.item
                                }["useProductSearch.useCallback[searchProducts]"]);
                            }
                        }
                    }
                    ...
                    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/products/search?q=".concat(encodeURIComponent(cleanedQuery)));
                    var _data_data;
                    results = (_data_data = data === null || data === void 0 ? void 0 : data.data) !== null && _data_data !== void 0 ? _data_data : [];
                }
...
_s(useProductSearch, "RymWi3FD4LCvEx6e8HosiaJNUNI=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function TableRow(param) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
        "data-slot": "table-row",
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("hover:bg-muted/50 data-[state=]:bg-muted border-b transition-colors", className),
        ...props
    }, void 0, false, {
        fileName: "[project]/src/components/ui/table.tsx",
        lineNumber: 57,
...
function CartTable(param) {
    let { cart, selectedRowId, selectRow, updateCartItemQuantity, updateCartItemPrice, deleteCartItem, disabled = false } = param;
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartTable.useEffect": ()=>{
            ...
            const trySelect = {
                "CartTable.useEffect.trySelect": ()=>{
                    if (cancelled) return;
                    const exists = cart.some({
                        "CartTable.useEffect.trySelect.exists": (it)=>it.id === lastAddedItemId
                    }["CartTable.useEffect.trySelect.exists"]);
                    if (exists) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartTable.useEffect": ()=>{
            if (lastAutoSelectedId.current && !cart.find({
                "CartTable.useEffect": (it)=>it.id === lastAutoSelectedId.current
            }["CartTable.useEffect"])) {
    ...
    const priceInputRefs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({});
    // Utility: focus search bar
    const focusSearchBar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartTable.useCallback[focusSearchBar]": ()=>{
            requestAnimationFrame({
                "CartTable.useCallback[focusSearchBar]": ()=>{
                    var _ps_select;
                    const ps = document.querySelector('[data-product-search="true"]');
                    ps === null || ps === void 0 ? void 0 : ps.focus();
                    ps === null || ps === void 0 ? void 0 : (_ps_select = ps.select) === null || _ps_select === void 0 ? void 0 : _ps_select.call(ps);
                }
            }["CartTable.useCallback[focusSearchBar]"]);
        }
    }["CartTable.useCallback[focusSearchBar]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartTable.useEffect": ()=>{
            function handleIncrementQty(e) {
                var _detail;
                const id = (_detail = e.detail) === null || _detail === void 0 ? void 0 : _detail.id;
                const item = cart.find({
                    "CartTable.useEffect.handleIncrementQty.item": (it)=>it.id === id
                }["CartTable.useEffect.handleIncrementQty.item"]);
                if (item) {
            ...
            function handleDecrementQty(e) {
                ...
                const id = (_detail = e.detail) === null || _detail === void 0 ? void 0 : _detail.id;
                const item = cart.find({
                    "CartTable.useEffect.handleDecrementQty.item": (it)=>it.id === id
                }["CartTable.useEffect.handleDecrementQty.item"]);
                if (item) {
            ...
            function handleEditPrice(e) {
                ...
                selectRow(id);
                setTimeout({
                    "CartTable.useEffect.handleEditPrice": ()=>{
                        var _input_select;
                        const input = priceInputRefs.current[id];
                        input === null || input === void 0 ? void 0 : input.focus();
                        input === null || input === void 0 ? void 0 : (_input_select = input.select) === null || _input_select === void 0 ? void 0 : _input_select.call(input);
                    }
                }["CartTable.useEffect.handleEditPrice"], 0);
            }
    ...
    const PriceCell = (param)=>{
        ...
        const [value, setValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(String((_item_product_price = item.product.price) !== null && _item_product_price !== void 0 ? _item_product_price : 0));
        const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "CartTable.PriceCell.useEffect": ()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "CartTable.PriceCell.useEffect": ()=>{
                var _item_product_price;
                if (!editing) setValue(String((_item_product_price = item.product.price) !== null && _item_product_price !== void 0 ? _item_product_price : 0));
            }
        }["CartTable.PriceCell.useEffect"], [
            item.product.price,
            editing
        ...
        const commit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
            "CartTable.PriceCell.useCallback[commit]": ()=>{
                setEditing(false);
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
            ...
            onKeyDown: (e)=>{
                if (e.key === "Enter") {
                    ...
                    setEditing(false);
                    var _item_product_price;
                    setValue(String((_item_product_price = item.product.price) !== null && _item_product_price !== void 0 ? _item_product_price : 0));
                    focusSearchBar();
                }
            },
            disabled: disabled
    ...
    _s1(PriceCell, "Fllhht33tWQSjt9TTOqG5RqaPbo=");
    // Add this custom quantity input component before the main CartTable component
    const QuantityInput = (param)=>{
        let { value, onChange, onFocus, onBlur, onKeyDown, disabled, itemId } = param;
        _s2();
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
            "CartTable.QuantityInput.useEffect": ()=>{
                if (!isEditing) {
            ...
            "CartTable.QuantityInput.useEffect": ()=>{
                if (isEditing && inputRef.current) {
                    const handleFocusLoss = {
                        "CartTable.QuantityInput.useEffect.handleFocusLoss": (e)=>{
                            ...
                            if (!target || target === document.body) {
                                e.preventDefault();
                                setTimeout({
                                    "CartTable.QuantityInput.useEffect.handleFocusLoss": ()=>{
                                        if (inputRef.current && isEditing) {
                                            inputRef.current.focus();
                                        }
                                    }
                                }["CartTable.QuantityInput.useEffect.handleFocusLoss"], 0);
                            }
                        }
                    }["CartTable.QuantityInput.useEffect.handleFocusLoss"];
    ...
    _s2(QuantityInput, "HWlxucd1on06QjXYgP1qN1TPwDE=");
    if (cart.length === 0) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: cart.map((item)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableRow"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                className: "py-3 px-4",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PriceCell, {
                                    item: item
                                }, void 0, false, {
                                    fileName: "[project]/src/app/dashboard/_pages/POS/components/leftColumn/CartTable.tsx",
                                    lineNumber: 400,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$table$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TableCell"], {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(QuantityInput, {
                                            value: item.quantity,
...
_s(CartTable, "IBA275QsZewS7ceZ/wLBluuKVBs=", false, function() {
    return [
...
function ProductSearch(param) {
    let { searchQuery, searchResults, showSearchResults, handleSearchChange, handleSearchSelect, clearSearch, disabled = false, inputRef, isScannerInputRef, isLoading, onAddProduct, handleDebugProductSelect, isDebugCheatCode } = param;
    _s();
            ...
            const handleKeyDown = {
                "ProductSearch.useEffect.handleKeyDown": (e)=>{
                    if (e.key === "ArrowDown") {
                        ...
                        e.stopPropagation();
                        setHighlightedIndex({
                            "ProductSearch.useEffect.handleKeyDown": (prev)=>prev < searchResults.length - 1 ? prev + 1 : 0
                        ...
                        e.stopPropagation();
                        setHighlightedIndex({
                            "ProductSearch.useEffect.handleKeyDown": (prev)=>prev > 0 ? prev - 1 : searchResults.length - 1
                        }["ProductSearch.useEffect.handleKeyDown"]);
                        scrollToHighlighted();
                    } else if (e.key === "Enter") {
                        ...
                        requestAnimationFrame({
                            "ProductSearch.useEffect.handleKeyDown": ()=>{
                                var _inputEl_select;
                                inputEl.focus();
                                (_inputEl_select = inputEl.select) === null || _inputEl_select === void 0 ? void 0 : _inputEl_select.call(inputEl);
                            }
                        }["ProductSearch.useEffect.handleKeyDown"]);
                    }
                }
    ...
    const shouldShowDropdown = showSearchResults && !(isScannerInputRef === null || isScannerInputRef === void 0 ? void 0 : isScannerInputRef.current) && searchResults.length > 0;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    isAutoSelecting && !(isScannerInputRef === null || isScannerInputRef === void 0 ? void 0 : isScannerInputRef.current) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
            ...
            shouldShowDropdown && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: searchResults.map((product, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        className: "p-3 cursor-pointer border-b last:border-b-0 ".concat(highlightedIndex === idx ? "bg-blue-100" : "hover:bg-gray-50"),
                        onClick: ()=>{
                            // Check if it's a debug product
                            if (isDebugCheatCode && handleDebugProductSelect && isDebugCheatCode(searchQuery)) {
                                handleDebugProductSelect(searchQuery);
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                product.name,
                                                isDebugCheatCode && isDebugCheatCode(searchQuery) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            showSearchResults && !(isScannerInputRef === null || isScannerInputRef === void 0 ? void 0 : isScannerInputRef.current) && searchResults.length === 0 && searchQuery.length >= 2 && !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "absolute top-full left-0 right-0 bg-white border rounded-md shadow-lg z-10 p-3 text-center text-gray-500",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-2",
                    ...
                    onAddProduct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
function POSLeftCol(param) {
    let { step } = param;
    _s();
    const { selectedRowId, selectRow, clearSelection } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useCartSelection$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartSelection"])();
    ...
    const { cart, updateCartItemQuantity, scanAndAddToCart, addProductToCart, updateCartItemPrice, deleteCartItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const focusSearchBar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSLeftCol.useCallback[focusSearchBar]": ()=>{
            requestAnimationFrame({
                "POSLeftCol.useCallback[focusSearchBar]": ()=>{
                    var _ps_select;
                    const ps = document.querySelector('[data-product-search="true"]');
    ...
    const priceEditRequestedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            ...
            const handleFocusBarcodeScanner = {
                "POSLeftCol.useEffect.handleFocusBarcodeScanner": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            const onEditRequest = {
                "POSLeftCol.useEffect.onEditRequest": ()=>{
                    priceEditRequestedRef.current = true;
                    setTimeout({
                        "POSLeftCol.useEffect.onEditRequest": ()=>priceEditRequestedRef.current = false
                    }["POSLeftCol.useEffect.onEditRequest"], 600);
                }
            }["POSLeftCol.useEffect.onEditRequest"];
            window.addEventListener("cart:edit-price", onEditRequest);
            return ({
                "POSLeftCol.useEffect": ()=>window.removeEventListener("cart:edit-price", onEditRequest)
            })["POSLeftCol.useEffect"];
        }
    }["POSLeftCol.useEffect"], []);
    ...
    const handleSearchSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSLeftCol.useCallback[handleSearchSelect]": (product)=>{
            addProductToCart(product);
            // clearSearch will be called by the useProductSearch hook
            setTimeout({
                "POSLeftCol.useCallback[handleSearchSelect]": ()=>{
                    try {
    ...
    const handleScanAndAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSLeftCol.useCallback[handleScanAndAddToCart]": async (barcode)=>{
            try {
                await scanAndAddToCart(barcode);
                // clearSearch will be called by the useProductSearch hook
                setTimeout({
                    "POSLeftCol.useCallback[handleScanAndAddToCart]": ()=>{
                        try {
                            var _productSearchInputRef_current, _productSearchInputRef_current_select, _productSearchInputRef_current1;
                            (_productSearchInputRef_current = productSearchInputRef.current) === null || _productSearchInputRef_current === void 0 ? void 0 : _productSearchInputRef_current.focus();
                            (_productSearchInputRef_current1 = productSearchInputRef.current) === null || _productSearchInputRef_current1 === void 0 ? void 0 : (_productSearchInputRef_current_select = _productSearchInputRef_current1.select) === null || _productSearchInputRef_current_select === void 0 ? void 0 : _productSearchInputRef_current_select.call(_productSearchInputRef_current1);
    ...
    const { searchQuery, searchResults, showSearchResults, handleSearchChange, clearSearch, isScannerInputRef, isLoading, handleDebugProductSelect, isDebugCheatCode } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$pos$2f$leftCol$2f$useProductsSearch$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProductSearch"])(handleSearchSelect, products, handleScanAndAddToCart);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            const handleProductAdded = {
                "POSLeftCol.useEffect.handleProductAdded": ()=>{
            ...
            return ({
                "POSLeftCol.useEffect": ()=>window.removeEventListener("product:added", handleProductAdded)
            })["POSLeftCol.useEffect"];
        }
    }["POSLeftCol.useEffect"], [
        clearSearch
    ...
    const handleUnregisteredBarcode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSLeftCol.useCallback[handleUnregisteredBarcode]": (barcode)=>{
            setUnregisteredBarcode(barcode);
            setShowRegisterDialog(true);
        }
    }["POSLeftCol.useCallback[handleUnregisteredBarcode]"], []);
    // ✅ FIXED: Listen for unregistered barcode events from cart-context
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "POSLeftCol.useEffect": ()=>{
            const handleUnregisteredBarcodeEvent = {
                "POSLeftCol.useEffect.handleUnregisteredBarcodeEvent": (e)=>{
                    var _this;
                    const detail = (_this = e) === null || _this === void 0 ? void 0 : _this.detail;
                    if (detail === null || detail === void 0 ? void 0 : detail.barcode) {
                        handleUnregisteredBarcode(detail.barcode);
                    }
                }
            }["POSLeftCol.useEffect.handleUnregisteredBarcodeEvent"];
    ...
    const handleRegisterDialogClose = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSLeftCol.useCallback[handleRegisterDialogClose]": ()=>{
    ...
    const handleRegisterDialogConfirm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "POSLeftCol.useCallback[handleRegisterDialogConfirm]": ()=>{
            setShowRegisterDialog(false);
...
_s(POSLeftCol, "uQEIVLD3g7QqLXfjcTQgJGy4gDc=", false, function() {
    return [
...
function MainDashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MainDashboard.useEffect": ()=>{
            ...
            ;
            const handleCtrlB = {
                "MainDashboard.useEffect.handleCtrlB": (e)=>{
            ...
            }["MainDashboard.useEffect.handleCtrlB"];
            // Use capture phase to ensure this runs before other listeners
            window.addEventListener("keydown", handleCtrlB, true);
            return ({
                "MainDashboard.useEffect": ()=>window.removeEventListener("keydown", handleCtrlB, true)
            })["MainDashboard.useEffect"];
        }
    }["MainDashboard.useEffect"], []);
...
_s(MainDashboard, "M+qku7NJ3jaGDLILixW1QsV5D1M=");
_c = MainDashboard;
var _c;
...
_s(ProductTable, "vs0jD+kyUGOMexYc/vp6ncUjRu0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useCategories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCategories"]
    ];
...
const useSales = (params)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        ...
        params === null || params === void 0 ? void 0 : params.from,
        params === null || params === void 0 ? void 0 : params.to
    ]);
    return {
        sales,
        loading,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/global/fetching/useProducts.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useSales$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/global/fetching/useSales.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function Stats() {
    ...
    const { saleItems: todaysSaleItems = [], loading: saleItemsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useSaleItems$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSaleItems"])({
        from,
        to
    });
...
_s(Stats, "Pr0QbhBfbdmJzMTGTdTr28ODrvI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$global$2f$fetching$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"],
...
"[project]/src/app/dashboard/_pages/Dashboard/components/categoryStats.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProductStats() {
    ...
    const { data: saleItems = [], error, isLoading, isValidating } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(saleItemsUrl, fetcher, {
        keepPreviousData: true,
        revalidateOnFocus: false
    });
    // Fetch products to get unit information
    const { data: allProducts = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])('/products?limit=all', productsFetcher, {
        keepPreviousData: true,
        revalidateOnFocus: false
    });
    ...
    const handleBarClick = async (data)=>{
        ...
        try {
            ...
            const categoryProduct = allProducts.find((p)=>{
                return p.category_name === data.category || p.category_id && "Category ".concat(p.category_id) === data.category;
            });
            ...
            switch(tableSortOrder){
                case 'asc':
                    return [
                        ...
                        "ProductStats.useMemo[sortedProducts]": (a, b)=>(a.total || 0) - (b.total || 0)
                    }["ProductStats.useMemo[sortedProducts]"]);
                case 'desc':
                    return [
                        ...products
                    ].sort({
                        "ProductStats.useMemo[sortedProducts]": (a, b)=>(b.total || 0) - (a.total || 0)
                    }["ProductStats.useMemo[sortedProducts]"]);
                case 'recent':
                default:
                    ...
                    return [
                        ...
                        "ProductStats.useMemo[sortedProducts]": (a, b)=>{
            ...
            try {
                ...
                for (const category of categories){
                    try {
                        ...
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/sales-items/products-by-category?".concat(params.toString()));
                        const items = ((_response_data = response.data) === null || _response_data === void 0 ? void 0 : _response_data.data) || response.data || [];
                        ...
                        categoryTotalsMap[category] = Number(originalItem === null || originalItem === void 0 ? void 0 : originalItem.total_sales) || 0;
                    }
                }
            ...
            const arr = saleItems.map({
                "ProductStats.useMemo[chartData].arr": (si)=>{
                    ...
                    if (categoryUnitMap.has(si.category)) {
                        ...
                        }["ProductStats.useMemo[chartData].arr.categoryProduct"]);
                        if (categoryProduct && categoryProduct.unit) {
            ...
            switch(sortOrder){
                case 'asc':
                    return [
                        ...
                        "ProductStats.useMemo[chartData]": (a, b)=>a.total_sales - b.total_sales
                    }["ProductStats.useMemo[chartData]"]);
                case 'desc':
                    return [
                        ...arr
                    ].sort({
                        "ProductStats.useMemo[chartData]": (a, b)=>b.total_sales - a.total_sales
                    }["ProductStats.useMemo[chartData]"]);
                case 'recent':
                    return [
                        ...arr
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    "aria-hidden": true,
                                    className: "absolute inset-0 z-20 flex items-end px-4 pointer-events-none transition-opacity duration-300 ease-in-out ".concat(isUpdating || initialLoadingNoData ? 'opacity-100' : 'opacity-0'),
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollArea"], {
                            ...
                            children: [
                                loadingProducts && products.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function SalesStats() {
    var _range_from, _range_to, _range_from1, _range_to1;
    _s();
    const today = new Date();
    const startOfMonth = new Date(today.getFullYear(), today.getMonth(), 1);
    ...
    const salesUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[salesUrl]": ()=>{
            if (!(range === null || range === void 0 ? void 0 : range.from) || !(range === null || range === void 0 ? void 0 : range.to)) return '/sales';
            ...
            ;
            return "/sales?from=".concat(encodeURIComponent(fromIso), "&to=").concat(encodeURIComponent(toIso));
        }
    }["SalesStats.useMemo[salesUrl]"], [
        range === null || range === void 0 ? void 0 : (_range_from = range.from) === null || _range_from === void 0 ? void 0 : _range_from.getTime(),
        range === null || range === void 0 ? void 0 : (_range_to = range.to) === null || _range_to === void 0 ? void 0 : _range_to.getTime()
    ]);
    // Keep previous data during revalidation to avoid flicker
    const { data: sales = [], error, isLoading, isValidating } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(salesUrl, fetcher, {
        keepPreviousData: true,
        revalidateOnFocus: false
    });
    // Group by Manila date (YYYY-MM-DD)
    const groupedByDateMap = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[groupedByDateMap]": ()=>{
            const map = new Map();
            sales.forEach({
                "SalesStats.useMemo[groupedByDateMap]": (sale)=>{
    ...
    const chartSeries = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[chartSeries]": ()=>{
            let fromDate;
            let toDate;
            ...
            return days.map({
                "SalesStats.useMemo[chartSeries]": (d)=>{
        ...
        range === null || range === void 0 ? void 0 : (_range_from1 = range.from) === null || _range_from1 === void 0 ? void 0 : _range_from1.getTime(),
        range === null || range === void 0 ? void 0 : (_range_to1 = range.to) === null || _range_to1 === void 0 ? void 0 : _range_to1.getTime(),
        sales,
        groupedByDateMap,
        today
    ]);
    // --- NEW: compute chartDisplayData based on sortOrder ---
    const chartDisplayData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[chartDisplayData]": ()=>{
            ...
            if (sortOrder === 'asc') {
                arr.sort({
                    "SalesStats.useMemo[chartDisplayData]": (a, b)=>a.customer - b.customer
                }["SalesStats.useMemo[chartDisplayData]"]);
            } else if (sortOrder === 'desc') {
                arr.sort({
                    "SalesStats.useMemo[chartDisplayData]": (a, b)=>b.customer - a.customer
                }["SalesStats.useMemo[chartDisplayData]"]);
            }
            return arr;
        }
    ...
    const sortedDataForTable = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[sortedDataForTable]": ()=>{
            let arr = [
                ...chartSeries
            ];
            if (sortOrder === 'asc') arr.sort({
                "SalesStats.useMemo[sortedDataForTable]": (a, b)=>a.customer - b.customer
            }["SalesStats.useMemo[sortedDataForTable]"]);
            else if (sortOrder === 'desc') arr.sort({
                "SalesStats.useMemo[sortedDataForTable]": (a, b)=>b.customer - a.customer
            }["SalesStats.useMemo[sortedDataForTable]"]);
            return arr;
        }
    }["SalesStats.useMemo[sortedDataForTable]"], [
    ...
    const total = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[total]": ()=>chartSeries.reduce({
                "SalesStats.useMemo[total]": (acc, curr)=>acc + curr.customer
            }["SalesStats.useMemo[total]"], 0)
    }["SalesStats.useMemo[total]"], [
        chartSeries
    ]);
    // Detect "empty" period: all points are zero
    const isEmptyPeriod = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SalesStats.useMemo[isEmptyPeriod]": ()=>{
            return chartSeries.length > 0 && chartSeries.every({
                "SalesStats.useMemo[isEmptyPeriod]": (pt)=>{
                    var _pt_customer;
                    return ((_pt_customer = pt.customer) !== null && _pt_customer !== void 0 ? _pt_customer : 0) === 0;
                }
            }["SalesStats.useMemo[isEmptyPeriod]"]);
        }
    }["SalesStats.useMemo[isEmptyPeriod]"], [
    ...
    if (error && !sales.length) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "relative h-89 w-full",
                    children: [
                        initialLoadingNoData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        !initialLoadingNoData && isEmptyPeriod && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        !initialLoadingNoData && isUpdating && !isEmptyPeriod && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            "aria-hidden": true,
...
_s(SalesStats, "QQaFkUO/0RmkD/w34DlE+y6jneM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"]
    ];
});
_c = SalesStats;
var _c;
__turbopack_context__.k.register(_c, "SalesStats");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ProductStats() {
    ...
    const { data: productSales = [], error, isLoading, isValidating } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(productSalesUrl, fetcher, {
        keepPreviousData: true,
        revalidateOnFocus: false
    });
    // Transform the data to match our expected format
    const productSalesData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[productSalesData]": ()=>{
            if (productSales.length === 0) return [];
            const productMap = new Map();
            productSales.forEach({
                "ProductStats.useMemo[productSalesData]": (item)=>{
    ...
    const { data: allProducts = [] } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])('/products?limit=all', fetcher, {
        keepPreviousData: true,
        revalidateOnFocus: false
    });
    ...
    const productMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[productMap]": ()=>{
            const map = new Map();
            allProducts.forEach({
                "ProductStats.useMemo[productMap]": (product)=>{
    ...
    // Sort table data locally based on tableSortOrder
    const sortedProductDetails = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[sortedProductDetails]": ()=>{
            switch(tableSortOrder){
                case 'asc':
                    return [
                        ...productDetails
                    ].sort({
                        "ProductStats.useMemo[sortedProductDetails]": (a, b)=>(a.total || 0) - (b.total || 0)
                    }["ProductStats.useMemo[sortedProductDetails]"]);
                case 'desc':
                    return [
                        ...productDetails
                    ].sort({
                        "ProductStats.useMemo[sortedProductDetails]": (a, b)=>(b.total || 0) - (a.total || 0)
                    }["ProductStats.useMemo[sortedProductDetails]"]);
                case 'recent':
                default:
                    return [
                        ...
                        "ProductStats.useMemo[sortedProductDetails]": (a, b)=>{
                            const ta = a.last_purchase ? new Date(a.last_purchase).getTime() : 0;
                            const tb = b.last_purchase ? new Date(b.last_purchase).getTime() : 0;
                            return tb - ta;
                        }
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProductStats.useMemo[chartData]": ()=>{
            const arr = productSalesData.map({
                "ProductStats.useMemo[chartData].arr": (item)=>({
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                    ...
                    children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                " ",
                                                ((_productDetails_ = productDetails[0]) === null || _productDetails_ === void 0 ? void 0 : _productDetails_.unit) || 'units'
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/dashboard/_pages/Dashboard/components/productStats.tsx",
                                            lineNumber: 389,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$scroll$2d$area$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollArea"], {
                            className: "h-80 mt-4 rounded-md border bg-white",
                            children: [
                                loadingDetails && productDetails.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "p-4 text-center text-gray-600",
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    children: sortedProductDetails.map((p, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            className: "hover:bg-gray-50 transition",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    className: "p-2 border font-medium",
                                ...
                                }, void 0, true) : !loadingDetails && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "p-4 text-center text-gray-500",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$_pages$2f$Dashboard$2f$components$2f$categoryStats$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/dashboard/_pages/Dashboard/components/categoryStats.tsx [app-client] (ecmascript)");
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$dashboard$2f$_pages$2f$Dashboard$2f$components$2f$categoryStats$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                            fileName: "[project]/src/app/dashboard/_pages/Dashboard/dashboardScreen.tsx",
                            lineNumber: 15,
                            columnNumber: 50
                        }, this)
...
"[project]/src/app/dashboard/[site]/DashboardClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_65747f7b._.js.map