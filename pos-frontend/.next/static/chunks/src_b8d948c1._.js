...
function Receipt(param) {
    ...
    _s();
    const { cart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])();
    async function downloadPdf() {
        ...
        const items = (cart || []).map((ci)=>{
            var _ci_product, _ci_product1;
            const price = Number(((_ci_product = ci.product) === null || _ci_product === void 0 ? void 0 : _ci_product.price) || 0);
            const qty = Number(ci.quantity || 0);
            const desc = ci.product && (ci.product.name || ci.product.title) || ((_ci_product1 = ci.product) === null || _ci_product1 === void 0 ? void 0 : _ci_product1.barcode) || "Item";
            return {
                desc,
                qty,
        ...
        try {
            const res = await fetch("".concat(API_BASE, "/receipt"), {
                method: "POST",
                headers: {
...
_s(Receipt, "GQSP7DAu2z+QzdS9621Ip+kHB6w=", false, function() {
    return [
...
//# sourceMappingURL=src_b8d948c1._.js.map