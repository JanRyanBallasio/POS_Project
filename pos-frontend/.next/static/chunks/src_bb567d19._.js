...
"[project]/src/hooks/users/user.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const loginUser = async (credentials)=>{
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', credentials);
        const raw = response.data;
        // Require backend to provide accessToken and data
        if (!raw || !raw.accessToken || !raw.data) {
            throw new Error((raw === null || raw === void 0 ? void 0 : raw.message) || 'Invalid server response: missing accessToken or user data');
        }
        var _raw_success;
        return {
            success: (_raw_success = raw.success) !== null && _raw_success !== void 0 ? _raw_success : true,
            accessToken: raw.accessToken,
            data: raw.data
        };
    } catch (error) {
        var _error_response_data, _error_response;
        throw new Error(((_error_response = error.response) === null || _error_response === void 0 ? void 0 : (_error_response_data = _error_response.data) === null || _error_response_data === void 0 ? void 0 : _error_response_data.message) || error.message || 'Login failed');
    }
};
const registerUser = async (data)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register', {
            name: data.fullname,
...
function useAuthGuard() {
    ...
    const [isAuthenticated] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // force-authenticated during testing
...
_s(useAuthGuard, "821RzUQtLL0qxzqEexFWs1n5EV8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
function useRedirectIfAuth() {
    let redirectTo = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : '/dashboard/main';
    _s1();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRedirectIfAuth.useEffect": ()=>{
            // Prevent multiple checks
            if (hasChecked.current) return;
            hasChecked.current = true;
            const checkAuth = {
                "useRedirectIfAuth.useEffect.checkAuth": async ()=>{
                    try {
                        var _resp_data;
                        // Quick validation first
                        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccessToken"])();
                        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])();
                        if (token && user) {
                        ...
                        const hasRefreshCookie = "object" !== 'undefined' && document.cookie.includes('refreshToken=');
                        if (!hasRefreshCookie) return;
                        // Attempt refresh
                        const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/refresh');
                        if ((_resp_data = resp.data) === null || _resp_data === void 0 ? void 0 : _resp_data.accessToken) {
                            router.replace(redirectTo);
                        }
                    } catch (err) {
                        // Clean up on failure
            ...
            }["useRedirectIfAuth.useEffect.checkAuth"];
            checkAuth();
        }
    }["useRedirectIfAuth.useEffect"], [
        redirectTo,
...
_s1(useRedirectIfAuth, "Bk3cTo8d0UKKVYGQ9OlV8gZ0IEU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
function useRequireAuth() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRequireAuth.useEffect": ()=>{
            ...
            hasChecked.current = true;
            const checkAuth = {
                "useRequireAuth.useEffect.checkAuth": async ()=>{
                    try {
                        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccessToken"])();
                        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])();
                        if (!token || !user) {
                        ...
                        try {
                            ...
                            if (isExpired) {
                                // Try refresh
                                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/refresh');
                            }
                        } catch (e) {
                            router.replace(redirectTo);
                        }
            ...
            }["useRequireAuth.useEffect.checkAuth"];
            checkAuth();
        }
    }["useRequireAuth.useEffect"], [
        redirectTo,
...
_s2(useRequireAuth, "Bk3cTo8d0UKKVYGQ9OlV8gZ0IEU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$users$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/users/user.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/stores/userStore.ts [app-client] (ecmascript)");
...
function LoginForm() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuthGuard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRedirectIfAuth"])();
    ...
    const togglePasswordVisibility = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "LoginForm.useCallback[togglePasswordVisibility]": ()=>{
            setIsVisible({
                "LoginForm.useCallback[togglePasswordVisibility]": (prev)=>!prev
            }["LoginForm.useCallback[togglePasswordVisibility]"]);
        }
    }["LoginForm.useCallback[togglePasswordVisibility]"], []);
    const onSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$users$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])({
                username: username.trim(),
                password
            });
            // Validate response structure
            if (!(res === null || res === void 0 ? void 0 : res.accessToken) || !(res === null || res === void 0 ? void 0 : res.data)) {
                throw new Error("Invalid server response");
            }
            // Clear cache and set new data atomically
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invalidateCache"])();
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setAccessToken"])(res.accessToken);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUser"])(res.data);
...
_s(LoginForm, "soHfkeeU4G0Za3CyogXa7l4aHUE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuthGuard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRedirectIfAuth"],
...
//# sourceMappingURL=src_bb567d19._.js.map