        ...
        "useRequireAuth.useEffect": ()=>{
            async function check() {
                ...
                try {
                    ...
                    const newToken = (_resp_data = resp.data) === null || _resp_data === void 0 ? void 0 : _resp_data.accessToken;
                    if (newToken) {
                        localStorage.setItem('accessToken', newToken);
                        setChecking(false);
                        return;
...
function useRedirectIfAuth() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRedirectIfAuth.useEffect": ()=>{
            const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAccessToken"])() || ("object" !== 'undefined' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$userStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUser"])() ? localStorage.getItem('accessToken') : null);
            if (token) {
                router.replace(redirectTo);
            } else {
                // if no client token, attempt silent refresh
                ({
                    "useRedirectIfAuth.useEffect": async ()=>{
                        try {
                            var _resp_data;
                            const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/refresh');
                            const newToken = (_resp_data = resp.data) === null || _resp_data === void 0 ? void 0 : _resp_data.accessToken;
...
_s1(useRedirectIfAuth, "vQduR7x+OPXj6PSmJyFnf+hU7bg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
async function handleResponseData(resp) {
    var _resp_data;
    const data = (_resp_data = resp === null || resp === void 0 ? void 0 : resp.data) !== null && _resp_data !== void 0 ? _resp_data : {};
    if ((resp === null || resp === void 0 ? void 0 : resp.status) >= 400) throw new Error((data === null || data === void 0 ? void 0 : data.message) || (data === null || data === void 0 ? void 0 : data.error) || 'Request failed');
    return data;
}
async function registerUser(payload) {
    ...
    const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register', body);
    return handleResponseData(resp);
}
async function loginUser(payload) {
    const resp = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/login', payload);
    return handleResponseData(resp);
} // ...existing code...
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
function RegisterForm() {
    ...
    const onSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$users$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["registerUser"])({
                fullname,
                username,
                password
            });
            ...
            const msg = (err === null || err === void 0 ? void 0 : (_err_response = err.response) === null || _err_response === void 0 ? void 0 : (_err_response_data = _err_response.data) === null || _err_response_data === void 0 ? void 0 : _err_response_data.message) || (err === null || err === void 0 ? void 0 : err.message) || "Registration failed";
            alert(msg);
        } finally{
            setLoading(false);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "w-full max-w-sm flex flex-col items-center gap-6 pb-[10px] px-2",
            children: [
...
_s(RegisterForm, "84YwueIHMn5R6fjnjJZrrMka/9I=", false, function() {
    return [
...
//# sourceMappingURL=src_cf5b622f._.js.map